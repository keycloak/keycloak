...
{
	// Request parameter used to specify the parameter which should be added to the redirect-url to retrieve code
	private static final String KC_REDIRECT_PARAM_NAME = "kc_redirect_param_name";
   ...
   protected String getRedirectUri(String state) {
	   ...
	   String kc_redirect_param_value = null;
       ...
       String kc_redirect_param_name = getQueryParamValue(KC_REDIRECT_PARAM_NAME);
       url = UriUtils.stripQueryParam(url, KC_REDIRECT_PARAM_NAME);

       if( kc_redirect_param_name != null && kc_redirect_param_name.length() > 0 )
       {
    	   kc_redirect_param_value = getQueryParamValue(kc_redirect_param_name);
           url = UriUtils.stripQueryParam(url, kc_redirect_param_name);
       }
       ...
       if (kc_redirect_param_name != null && kc_redirect_param_name.length() > 0 && kc_redirect_param_value != null && kc_redirect_param_value.length() > 0) 
       {
           redirectUriBuilder.queryParam( kc_redirect_param_name, kc_redirect_param_value );
       }

       System.out.println(  redirectUriBuilder.build().toString() );
