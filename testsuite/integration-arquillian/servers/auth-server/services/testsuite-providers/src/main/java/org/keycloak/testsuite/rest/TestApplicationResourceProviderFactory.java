...
public class TestApplicationResourceProviderFactory implements RealmResourceProviderFactory {
    ...
    private ConcurrentMap<String, OIDCClientRepresentation> oidcClientRepresentations = new ConcurrentHashMap<>();
    private ConcurrentMap<String, String> clientMetadataCacheControlHeaders = new ConcurrentHashMap<>();


    @Override
    public RealmResourceProvider create(KeycloakSession session) {
        return new TestApplicationResourceProvider(session, adminLogoutActions,
                backChannelLogoutTokens, frontChannelLogoutTokens, pushNotBeforeActions, testAvailabilityActions, oidcClientData, authenticationChannelRequests, cibaClientNotifications, intentClientBindings, oidcClientRepresentations, clientMetadataCacheControlHeaders);
    }
