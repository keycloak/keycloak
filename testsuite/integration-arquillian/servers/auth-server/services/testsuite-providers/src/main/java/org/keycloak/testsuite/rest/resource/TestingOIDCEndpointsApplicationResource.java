...
public class TestingOIDCEndpointsApplicationResource {
    ...
    public Map<String, String> getKeysAsBase64() {
        ...
        TestApplicationResourceProviderFactory.OIDCKeyData keyData = clientData.getFirstKey();
        String privateKeyPem = java.util.Base64.getEncoder().encodeToString(keyData.getSigningKeyPair().getPrivate().getEncoded());
        String publicKeyPem = java.util.Base64.getEncoder().encodeToString(keyData.getSigningKeyPair().getPublic().getEncoded());
