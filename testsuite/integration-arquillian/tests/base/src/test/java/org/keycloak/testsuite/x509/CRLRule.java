...
public class CRLRule extends ExternalResource {
    ...
    protected void before() throws Throwable {
        ...
        handlers.put(AbstractX509AuthenticationTest.EMPTY_CRL_PATH, new CRLHandler(AbstractX509AuthenticationTest.EMPTY_CRL_PATH));
        handlers.put(AbstractX509AuthenticationTest.EMPTY_EXPIRED_CRL_PATH, new CRLHandler(AbstractX509AuthenticationTest.EMPTY_EXPIRED_CRL_PATH));
        handlers.put(AbstractX509AuthenticationTest.INTERMEDIATE_CA_CRL_PATH, new CRLHandler(AbstractX509AuthenticationTest.INTERMEDIATE_CA_CRL_PATH));
        handlers.put(AbstractX509AuthenticationTest.INTERMEDIATE_CA_INVALID_SIGNATURE_CRL_PATH, new CRLHandler(AbstractX509AuthenticationTest.INTERMEDIATE_CA_INVALID_SIGNATURE_CRL_PATH));
        handlers.put(AbstractX509AuthenticationTest.INTERMEDIATE_CA_3_CRL_PATH, new CRLHandler(AbstractX509AuthenticationTest.INTERMEDIATE_CA_3_CRL_PATH));
        handlers.put(AbstractX509AuthenticationTest.INVALID_CRL_PATH, new CRLHandler(AbstractX509AuthenticationTest.INVALID_CRL_PATH));

        pathHandler = new PathHandler();
        for (Map.Entry<String, CRLHandler> entry : handlers.entrySet()) {
            pathHandler.addExactPath(entry.getKey(), entry.getValue());
        }
