...
public class KcSamlBrokerConfiguration implements BrokerConfiguration {
    ...
    public IdentityProviderRepresentation setUpIdentityProvider(IdentityProviderSyncMode syncMode) {
        ...
        // Use REDIRECT binding for AuthnRequest when login hint forwarding is enabled in tests so that
        // the destination URL (including query params) is visible in the browser URL for assertions.
        // This applies to both loginHint and loginQueryHint based test cases.
        config.put(POST_BINDING_AUTHN_REQUEST, String.valueOf(!(loginHint || loginQueryHint)));
