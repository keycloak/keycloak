    ...
    public void testWithTokenAuthEnabledAndSavedCredentials() throws Exception {
        ...
        try {
            ...
            try (var result = realm.clients().create(clientRepresentation)) {
                ...
                greenMailRule.credentials("admin@localhost",token -> {
                    var accessToken = new OAuthClient()
                            .realm(realm.toRepresentation().getRealm())
    ...
    public void testWithTokenAuthEnabledAndSavedCredentialsRetryGivesUp() throws Exception {
        ...
        try {
            ...
            try (var result = realm.clients().create(clientRepresentation)) {
                ...
                greenMailRule.credentials("admin@localhost", token -> false);
