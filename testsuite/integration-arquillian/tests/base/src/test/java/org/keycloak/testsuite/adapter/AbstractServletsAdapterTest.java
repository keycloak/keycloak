...
public abstract class AbstractServletsAdapterTest extends AbstractAdapterTest {
    ...
    protected static Consumer<AdapterConfig> GLOBAL_HTTP_CLIENT_JSON_CONFIG;
    ...
    protected static WebArchive servletDeploymentMultiTenant(String name, Class... servletClasses) {
        return servletDeploymentMultiTenant(name, null, servletClasses);
    }

    protected static WebArchive servletDeploymentMultiTenant(String name, Consumer<AdapterConfig> adapterConfig, Class... servletClasses) {
        WebArchive servletDeployment = servletDeployment(name, adapterConfig, servletClasses);
    ...
    protected static WebArchive servletDeployment(String name, String adapterConfigName, Consumer<AdapterConfig> adapterConfig, Class... servletClasses) {
        ...
        if (configFile != null) {
            deployment.addAsWebInfResource(keycloakJSON, DEFAULT_ADAPTER_CONFIG);
        }
    ...
    protected static File updateJsonConfigFile(URL configFile, Consumer<AdapterConfig> adapterConfig) {
        ...
        final Consumer<AdapterConfig> finalAdapterConfig = adapterConfig != null ? adapterConfig : GLOBAL_HTTP_CLIENT_JSON_CONFIG;

        if (config != null && finalAdapterConfig != null) {
            finalAdapterConfig.accept(config);
