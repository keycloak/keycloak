...
public class AdminClientTest extends AbstractKeycloakTest {
    ...
    public void importRealm(RealmRepresentation realm) {
        ...
        if (Objects.equals(realm.getRealm(), realmName)) {
            x509ClientUUID = adminClient.realm(realmName).clients().findClientByClientId(x509ClientId).getId();
            clientUUID = adminClient.realm(realmName).clients().findClientByClientId(clientId).getId();
