...
public class CIBATest extends AbstractClientPoliciesTest {
    ...
    public void testAttackerClientUseVictimAuthReqIdAttack() throws Exception {
        ...
        try {
            ...
            AccessTokenResponse tokenRes = oauth.doBackchannelAuthenticationTokenRequest(attackerClientName, TEST_CLIENT_PASSWORD, victimClientAuthReqId);
...
//            oauth.doAuthenticationChannelCallback(SECOND_TEST_CLIENT_NAME, SECOND_TEST_CLIENT_SECRET, usernameAuthenticated, authenticationChannelReq.getBearerToken(), SUCCEEDED);
    ...
    public void testPingMode_clientNotificationSentEvenForUserCancel() throws Exception {
        ...
        try {
            ...
            // user Token Request
            AccessTokenResponse tokenRes = oauth.doBackchannelAuthenticationTokenRequest(TEST_CLIENT_PASSWORD, response.getAuthReqId());
    ...
    public void testMultipleUsersBackchannelAuthenticationFlows() throws Exception {
        ...
        try {
            ...
            doBackchannelAuthenticationTokenRequest(secondUsername, secondUserAuthReqId);

            // first user Token Request
            doBackchannelAuthenticationTokenRequest(firstUsername, firstUserAuthReqId);
    ...
    public void testExplicitConsentRequiredBackchannelAuthenticationFlows() throws Exception {
        ...
        try {
            ...
            AccessTokenResponse tokenRes = doBackchannelAuthenticationTokenRequest(clientName, clientPassword, username, clientAuthReqId);
    ...
    public void testMultipleClientsBackchannelAuthenticationFlows() throws Exception {
        ...
        try {
            ...
            String firstClientAuthReqId;
            String secondClientAuthReqId;
            ...
            AccessTokenResponse tokenRes = doBackchannelAuthenticationTokenRequest(secondClientName, secondClientPassword, username, secondClientAuthReqId);
    ...
    public void testVerifyHolderOfAuthenticationRequestRef() throws Exception {
        ...
        try {
            ...
            // second client Token Request
            AccessTokenResponse tokenRes = oauth.doBackchannelAuthenticationTokenRequest(secondClientName, TEST_CLIENT_PASSWORD, firstClientAuthReqId);
    ...
    public void testOtherClientSendTokenRequest() throws Exception {
        ...
        try {
            ...
            // user Token Request
            AccessTokenResponse tokenRes = oauth.doBackchannelAuthenticationTokenRequest(SECOND_TEST_CLIENT_NAME, SECOND_TEST_CLIENT_SECRET, response.getAuthReqId());
            assertThat(tokenRes.getStatusCode(), is(equalTo(400)));
            assertThat(tokenRes.getError(), is(OAuthErrorException.INVALID_GRANT));
    ...
    @Test
    public void testInvalidConsumptionDeviceRegistration() {
        try {
            createClientDynamically("invalid-CIBA-CD", (OIDCClientRepresentation clientRep) -> clientRep.setBackchannelTokenDeliveryMode("pushpush"));
            fail();
        ...
        String json = (new ClientProfilesBuilder()).addProfile(
                (new ClientProfileBuilder()).createProfile(PROFILE_NAME, "Den Forste Profilen")
                    .addExecutor(TestRaiseExceptionExecutorFactory.PROVIDER_ID,
                            createTestRaiseExeptionExecutorConfig(List.of(ClientPolicyEvent.BACKCHANNEL_AUTHENTICATION_REQUEST)))
                    .toRepresentation()
                ).toString();
        updateProfiles(json);
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "Den Forste Politikken", Boolean.TRUE)
                        .addCondition(ClientRolesConditionFactory.PROVIDER_ID,
                                createClientRolesConditionConfig(List.of(roleName)))
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
        updatePolicies(json);
    ...
    public void testExtendedClientPolicyInterfacesForBackchannelTokenRequest() throws Exception {
        ...
        String json = (new ClientProfilesBuilder()).addProfile(
                (new ClientProfileBuilder()).createProfile(PROFILE_NAME, "Den Forste Profilen")
                    .addExecutor(TestRaiseExceptionExecutorFactory.PROVIDER_ID,
                            createTestRaiseExeptionExecutorConfig(List.of(ClientPolicyEvent.BACKCHANNEL_TOKEN_REQUEST)))
                    .toRepresentation()
                ).toString();
        updateProfiles(json);
        ...
        AccessTokenResponse tokenRes = oauth.doBackchannelAuthenticationTokenRequest(clientId, clientSecret, response.getAuthReqId());
        assertThat(tokenRes.getStatusCode(), is(equalTo(400)));
        assertThat(tokenRes.getError(), is(OAuthErrorException.INVALID_GRANT));
    ...
    public void testExtendedClientPolicyInterfacesForBackchannelTokenResponse() throws Exception {
        ...
        String json = (new ClientProfilesBuilder()).addProfile(
                (new ClientProfileBuilder()).createProfile(PROFILE_NAME, "Den Forste Profilen")
                    .addExecutor(TestRaiseExceptionExecutorFactory.PROVIDER_ID,
                            createTestRaiseExeptionExecutorConfig(List.of(ClientPolicyEvent.BACKCHANNEL_TOKEN_RESPONSE)))
                    .toRepresentation()
                ).toString();
        updateProfiles(json);
    ...
    public void testHolderOfKeyEnforceExecutor() throws Exception {
        ...
        try {
            ...
            try (CloseableHttpClient client = MutualTLSUtils.newCloseableHttpClientWithDefaultKeyStoreAndTrustStore()) {
                ...
                accessTokenResponse = doBackchannelAuthenticationTokenRequest(TEST_CLIENT_NAME, TEST_CLIENT_PASSWORD, username, response.getAuthReqId());
    ...
    public void testConfidentialClientAcceptExecutorExecutor() throws Exception {
        ...
        createClientByAdmin(clientPublicId, (ClientRepresentation clientRep) -> {
        ...
        // user Token Request
        AccessTokenResponse tokenRes = oauth.doBackchannelAuthenticationTokenRequest(clientConfidentialId, clientConfidentialSecret, response.getAuthReqId());
        assertThat(tokenRes.getStatusCode(), is(equalTo(400)));
        assertThat(tokenRes.getError(), is(OAuthErrorException.INVALID_GRANT));
    ...
    public void testClientScopesCondition() throws Exception {
        ...
        String clientConfidentialId = generateSuffixedName("confidential-app");
        String clientConfidentialSecret = "app-secret";
        createClientByAdmin(clientConfidentialId, (ClientRepresentation clientRep) -> {
            clientRep.setSecret(clientConfidentialSecret);
            clientRep.setStandardFlowEnabled(Boolean.TRUE);
            clientRep.setImplicitFlowEnabled(Boolean.TRUE);
            clientRep.setPublicClient(Boolean.FALSE);
    ...
    protected void registerSharedInvalidAuthenticationRequest(AuthorizationEndpointRequestObject requestObject, String clientId, String sigAlg, boolean isUseRequestUri) throws IOException {
        TestOIDCEndpointsApplicationResource oidcClientEndpointsResource;
    ...
    private boolean isSymmetricSigAlg(String sigAlg) {
        ...
        return Algorithm.HS512.equals(sigAlg);
    }
    ...
    private AccessTokenResponse doBackchannelAuthenticationTokenRequest(String clientId, String clientSecret, String username, String authReqId) throws Exception {
        AccessTokenResponse tokenRes = oauth.doBackchannelAuthenticationTokenRequest(clientId, clientSecret, authReqId);
    ...
    private EventRepresentation doLogoutByRefreshToken(String refreshToken, String sessionId, String userId, boolean isOfflineAccess) {
