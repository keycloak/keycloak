...
public abstract class AbstractSamlTest extends AbstractAuthTest {
    ...
    public static final String REALM_PRIVATE_KEY = (BouncyIntegration.PROVIDER.startsWith("BC"))?
    ...
    public static final String SAML_CLIENT_SALES_POST_ENC_PRIVATE_KEY = (BouncyIntegration.PROVIDER.startsWith("BC"))?
