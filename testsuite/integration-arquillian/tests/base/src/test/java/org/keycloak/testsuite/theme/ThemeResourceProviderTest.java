...
public class ThemeResourceProviderTest extends AbstractTestRealmKeycloakTest {
    ...
    public void fetchStaticResourceShouldRedirectOnUnknownVersion() throws IOException {
        ...
        assertNotFound(suiteContext.getAuthServerInfo().getContextRoot().toString() + "/auth/resources/" + "unknown" + "/login/keycloak.v2/css%2Fstyles.css");
        assertNotFound(suiteContext.getAuthServerInfo().getContextRoot().toString() + "/auth/resources/" + "unknown%2F" + "/login/keycloak.v2/css/styles.css");
        ...
        // assertNotFound(suiteContext.getAuthServerInfo().getContextRoot().toString() + "/auth/resources/" + "unknown" + "/login/keycloak.v2/css/../css/styles.css");
        assertRedirectAndValidateRedirect(suiteContext.getAuthServerInfo().getContextRoot().toString() + "/auth/resources/" + "unknown" + "/login/keycloak.v2/css/styles.css?name=%2Fvalue",
