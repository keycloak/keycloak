...
public class ProvidersTest extends AbstractAuthenticationTest {
    ...
    private List<Map<String, Object>> expectedAuthProviders() {
        ...
        addProviderInfo(result, "basic-auth", "Basic Auth Challenge",
                "Basic auth challenge.");
        addProviderInfo(result, "basic-auth-otp", "Basic Auth Password+OTP",
                "Basic auth challenge with OTP.  Password param should contain a combination of password + otp.  Realm's OTP policy is used to determine how to parse this.  This SHOULD NOT BE USED in conjection with regular basic auth provider.");
        ...
        addProviderInfo(result, "no-cookie-redirect", "Browser Redirect/Refresh",
