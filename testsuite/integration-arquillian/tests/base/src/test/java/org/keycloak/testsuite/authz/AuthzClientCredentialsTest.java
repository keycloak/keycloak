...
public class AuthzClientCredentialsTest extends AbstractAuthzTest {
    ...
    private AuthzClient getAuthzClient(String adapterConfig) {
        ...
        return AuthzClient.create(new Configuration(deployment.getAuthServerBaseUrl(), null , deployment.getResourceName(), deployment.getResourceCredentials(), deployment.getClient(),
            deployment.getRealm()), new ClientAuthenticator() {
            @Override
