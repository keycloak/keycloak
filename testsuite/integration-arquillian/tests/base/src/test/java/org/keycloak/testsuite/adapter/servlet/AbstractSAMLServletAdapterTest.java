...
public abstract class AbstractSAMLServletAdapterTest extends AbstractServletsAdapterTest {
    ...
    protected Pattern sessionIdPattern = Pattern.compile("Session ID: (.*)");
    protected Pattern notOnOrAfterPattern = Pattern.compile("SessionNotOnOrAfter: (.*)");
    ...
    protected String extractByPattern(Pattern p) {
