...
public class InitialFlowsTest extends AbstractAuthenticationTest {
    ...
    private LinkedList<FlowExecutions> expectedFlows() {
        ...
        execs = new LinkedList<>();
        flow = newFlow(DefaultAuthenticationFlows.OPENSHIFT_CHALLENGE_FLOW, DefaultAuthenticationFlows.OPENSHIFT_CHALLENGE_FLOW_DESCRIPTION, "basic-flow", true, true);
        ...
        addExecInfo(execs, "Basic Auth Challenge", "basic-auth", false, 0, 1, REQUIRED, null, new String[]{REQUIRED, DISABLED});
        addExecInfo(execs, "Basic Auth Password+OTP", "basic-auth-otp", false, 0, 2, DISABLED, null, new String[]{REQUIRED, DISABLED});
