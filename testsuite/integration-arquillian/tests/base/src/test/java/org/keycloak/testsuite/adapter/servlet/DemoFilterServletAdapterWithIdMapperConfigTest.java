...
@UseServletFilter(filterName = "oidc-filter", filterClass = "org.keycloak.adapters.servlet.KeycloakOIDCFilter",
        filterDependency = "org.keycloak:keycloak-servlet-filter-adapter", skipPattern = "/error.html", configIdMapperClass = "org.keycloak.helpers.TestInMemorySessionIdMapper")
public class DemoFilterServletAdapterWithIdMapperConfigTest extends DemoServletsAdapterTest {
