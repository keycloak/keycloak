...
public abstract class OID4VCAuthorizationDetailsFlowTestBase extends OID4VCIssuerEndpointTest {
    ...
    public void testPreAuthorizedCodeWithAuthorizationDetailsCredentialConfigurationId() throws Exception {
        ...
        String preAuthCode = ctx.credentialsOffer.getGrants().getPreAuthorizedCode().getPreAuthorizedCode();
    ...
    public void testCompleteFlowWithCredentialOfferBasedAuthorizationDetails() throws Exception {
        ...
        //      * It must guarantee isolation of state tied to the VC issuance flow.
        {
            ...
            Oid4vcCredentialResponse credentialResponse = oauth.oid4vc().credentialRequest(credRequest)
    ...
    public void testCredentialRequestWithEmptyPayload() throws Exception {
        ...
        Oid4vcCredentialResponse credentialResponse = oauth.oid4vc().credentialRequest(null)
                .endpoint(ctx.credentialIssuer.getCredentialEndpoint())
                .bearerToken(token)
                .emptyBody()
                .send();
    ...
    public void testCredentialRequestWithInvalidCredentialIdentifier() throws Exception {
        ...
        CredentialRequest credRequest = new CredentialRequest().setCredentialIdentifier("invalid-credential-identifier");
        Oid4vcCredentialResponse credentialResponse = oauth.oid4vc().credentialRequest(credRequest)
                .endpoint(ctx.credentialIssuer.getCredentialEndpoint())
                .bearerToken(token)
                .send();
