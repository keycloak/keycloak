...
public class OidcClaimToUserSessionNoteMapperTest extends AbstractIdentityProviderMapperTest {
    ...
    public void setup() {
        ...
        consumerClientRep = consumerRealm.clients().findClientByClientId("broker-app");
        ...
        ClientRepresentation providerClientRep = providerRealm.clients().findClientByClientId("brokerapp");
