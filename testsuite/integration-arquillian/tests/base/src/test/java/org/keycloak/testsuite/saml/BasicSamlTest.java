...
public class BasicSamlTest extends AbstractSamlTest {
    ...
    private void testEncryption(String algorithm, String keyAlgorithm, String digestMethod, String maskGenerationFunction,
        ...
        X509Certificate cert = CertificateUtils.generateV1SelfSignedCertificate(rsaKeyPair, "test");

        try (var c = ClientAttributeUpdater.forClient(adminClient, REALM_NAME, SAML_CLIENT_ID_SALES_POST)
                .setAttribute(SamlConfigAttributes.SAML_SERVER_SIGNATURE, "true")
                .setAttribute(SamlConfigAttributes.SAML_ENCRYPT, "true")
                .setAttribute(SamlConfigAttributes.SAML_ENCRYPTION_CERTIFICATE_ATTRIBUTE, PemUtils.encodeCertificate(cert))
            ...
            AssertionUtil.decryptAssertion(responseType, (EncryptedData encryptedData) -> Collections.singletonList(rsaKeyPair.getPrivate()));
    ...
    public void testEncryptionDefault() throws Exception {
        testEncryption("", "", "", "", XMLCipher.AES_128, XMLCipher.RSA_OAEP, "", "");
    }
