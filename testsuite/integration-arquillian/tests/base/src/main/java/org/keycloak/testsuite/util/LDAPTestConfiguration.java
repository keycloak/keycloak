...
public class LDAPTestConfiguration {
    ...
    static {
        ...
        PROP_MAPPINGS.put(KerberosConstants.KERBEROS_PRINCIPAL_LDAP_ATTRIBUTE, "idm.test.kerberos.principal.ldap.attribute");
        ...
        DEFAULT_VALUES.put(KerberosConstants.KERBEROS_PRINCIPAL_LDAP_ATTRIBUTE, KerberosConstants.KERBEROS_PRINCIPAL_LDAP_ATTRIBUTE_KRB5_PRINCIPAL_NAME);
