...
import org.keycloak.crypto.KeyPairSignatureVerifierContext;
...
public class OAuthClient {
    ...
    public RefreshToken verifyRefreshToken(String refreshToken) {
        return verifyToken(refreshToken, RefreshToken.class);
    }
    ...
    public <T extends JsonWebToken> T verifyToken(String token, Class<T> clazz) {
        try {
            ...
            KeyPairSignatureVerifierContext verifierContext = new KeyPairSignatureVerifierContext(key);
