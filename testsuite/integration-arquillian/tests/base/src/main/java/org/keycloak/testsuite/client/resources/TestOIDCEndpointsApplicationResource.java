...
public interface TestOIDCEndpointsApplicationResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @NoCache
    OIDCClientRepresentation registerClientIdMetadata(OIDCClientRepresentation oidcClientRepresentation, @QueryParam("cacheControlHeaderValue") String cacheControlHeaderValue);
