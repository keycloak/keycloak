...
NOTE: To restrict delegation to specific users, select individual users when creating the permission. To restrict which administrators can delegate, use a more specific policy (for example, a *User* policy).
