...
* It is not supported for public clients to send the token exchange requests. Token exchange V1 include very limited support for public clients, allowing public clients to exchange the token to itself with fewer scopes.
