...
|link:https://datatracker.ietf.org/doc/draft-ietf-oauth-identity-assertion-authz-grant/[Identity Assertion Authorization Grant] (Draft)|Experimental||Issuing side (ID-JAG). See <@links.securingapps id="identity-assertion-grant" />.
