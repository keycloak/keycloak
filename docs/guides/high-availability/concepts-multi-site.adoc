...
Since such a deployment is expected to have worse performance and an inferior, adding additional sites would require a non-trivial effort to optimize and test.
