...
With https://github.com/keycloak/keycloak/issues/22109[keycloak#22109] being available in {project_name} 22.0.5, disabling these probes is no longer recommended.
====
