...
<@tmpl.guide
title="Deploying {project_name} for HA with the {project_name} Operator"
summary="Deploy {project_name} for HA with the {project_name} Operator as a building block for a {project_name} deployment."
tileVisible="false" >
