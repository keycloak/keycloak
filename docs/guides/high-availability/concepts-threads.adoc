...
Read this page to understand considerations and best practices on how to configure thread pools connection pools for {project_name}.
...
{project_name} requests are handled on the Quarkus executor pool, as well as all probes.
