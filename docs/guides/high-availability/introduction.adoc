...
<@profile.ifCommunity>
=== Multi-cluster deployments (experimental)

Connect two or more {project_name} clusters without an external {jdgserver_name} cluster using <@links.ha id="multi-cluster-experimental-introduction" />.
...
* <@links.ha id="multi-cluster-experimental-introduction" />
</@profile.ifCommunity>
