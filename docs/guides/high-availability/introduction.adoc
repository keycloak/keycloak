...
** Higher database load as session data is stored in the database and less data is cached. You might see a two times higher CPU usage and write IOPS on your database, though your results might vary based on your use case.
</@profile.ifCommunity>
