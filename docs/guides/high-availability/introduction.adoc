...
WARNING: Multi-cluster v1 (the `multi-site` feature) is deprecated and will be removed in a future release. Use <@links.ha id="multi-cluster-v2-introduction" /> instead. See <@links.ha id="multi-cluster-v2-migrate-from-v1-to-v2" /> for migration instructions.
