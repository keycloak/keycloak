...
[NOTE]
====
The link:{keycloak_benchmark_link}[{keycloak_benchmark_name}] can be used to ensure that deployments are able to handle
...
* <@links.ha id="single-cluster-deploy-cnpg" />
* <@links.ha id="single-cluster-deploy-cnpg-with-backup" />
* <@links.ha id="single-cluster-monitoring-cnpg" />
* <@links.ha id="single-cluster-deploy-cnpg-recovery" />
* <@links.ha id="single-cluster-deploy-keycloak" />
* <@links.ha id="single-cluster-operate-cnpg-switchover" />
