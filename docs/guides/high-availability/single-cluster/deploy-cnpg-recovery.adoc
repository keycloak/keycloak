...
== Recovering the CloudNativePG cluster from a backup
...
. Enable scheduled backups for the recovered cluster as described in <@links.ha id="single-cluster-deploy-cnpg-with-backup" anchor="single-cluster-cnpg-enabling-scheduled-backups" />.
