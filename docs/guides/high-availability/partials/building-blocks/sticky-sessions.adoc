...
The recommended way to run {project_name} behind a load balancer is to disable sticky session to allow for an even distribution of requests across all nodes.
