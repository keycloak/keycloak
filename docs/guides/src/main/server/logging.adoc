...
=== Configuring the file rotation
The file rotation can be configured using quarkus properties, as described in guide <@links.server configuration/> at section _Using raw Quarkus properties_.
