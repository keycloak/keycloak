...
<@tmpl.guide
title="Policy enforcers"
priority=90
summary="Understand Policy Enforcement Points and how to use them with {project_name}.">
...
* https://www.keycloak.org/securing-apps/policy-enforcer[Java Policy enforcer] - useful to be used in the Java client applications
