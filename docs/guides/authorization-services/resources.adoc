...
<@tmpl.guide
title="Managing resources and scopes"
priority=40
summary="Create and manage protected resources and their associated scopes.">
...
.Resources
image::resource/view.png[alt="Resources"]
...
.Add resource
image::resource/create.png[alt="Add resource"]
