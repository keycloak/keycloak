...
<@kc.start parameters="--features=opentelemetry-logs --log-export-enabled=true"/>
...
<@features.techpreview feature="opentelemetry-metrics"/>
...
<@kc.start parameters="--features=opentelemetry-metrics --metrics-enabled=true --metrics-export-enabled=true"/>
