...
<@tmpl.guide
title="Tracking status information of instances with health checks"
summary="Check if an instance has finished its start up and is ready to serve requests."
