...
| 95% of all authentication related requests should be faster than 250 ms within a month.
...
| The rate of errors due to server problems for authentication requests should be less than 0.1% within a month.
