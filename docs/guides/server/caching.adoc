...
The table below shows the ports that need to be open, the protocol used, and a description of the traffic that goes through it.

|===
|Port |Protocol |Stack |Property | Description

.2+.^m|7800
| TCP
|TCP based stacks
.2+m|jgroups.bind.address
.2+|Unicast data transmission.
|UDP
|UDP based stacks
