...
Traefik sends the client certificate and any intermediate CA certificates as URL-encoded PEM blocks in a single `X-Forwarded-Tls-Client-Cert` header, separated by commas.
