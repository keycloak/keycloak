...
find the *Action* menu in the top right corner of the realm settings screen, and finally select the *Partial export*
...
then find the *Action* menu in the top right corner for the realm settings screen, and finally select the *Partial import*
