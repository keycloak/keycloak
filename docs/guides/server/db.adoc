...
You can override either property by setting your own values in the DB URL or additional properties. These properties are not set when a custom JDBC driver is used (for example, the AWS JDBC Wrapper).
