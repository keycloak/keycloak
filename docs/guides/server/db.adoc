...
However, on MS SQL Server, the database isolation level needs to be modified by executing the following command on your database: `ALTER DATABASE [your-database-name] SET READ_COMMITTED_SNAPSHOT ON;`
