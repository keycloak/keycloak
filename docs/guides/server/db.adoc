...
NOTE: The `ALTER DATABASE` command requires exclusive access to the database. Ensure no other user connections are active, or the command will block until all other connections are closed.
