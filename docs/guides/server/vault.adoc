...
== Enabling a vault
To enable the file-based vault you need to set the build time option `vault` to `file`.

For the Java KeyStore-based vault you need to instead specify the value `keystore`.
