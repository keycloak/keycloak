...
Keycloak includes a `service` subcommand to simplify service creation and deletion.
...
[source,bash]
----
bin\kc.bat service delete --help
----

=== Examples

Create a basic service (runs as Local System by default):
...
bin\kc.bat service create --service-user="DOMAIN\Username"
----
...
[source,bash]
----
bin\kc.bat service delete --name keycloak
----
