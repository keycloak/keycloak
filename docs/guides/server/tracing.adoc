...
When tracing is enabled, the trace information is included in the log messages of all enabled log handlers (see more in the logging https://www.keycloak.org/server/logging[guide]).
