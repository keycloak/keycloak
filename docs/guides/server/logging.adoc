...
If you want to have JSON logs in *ECS* (Elastic Common Schema) format, you can enter the following command:
...
To use unstructured logging (default), enter the following command:
...
By default, the file log handler logs plain unstructured data to the particular file.
To use structured JSON log output instead, enter the following command:

<@kc.start parameters="--log-file-output=json"/>

==== ECS JSON format

If you want to have JSON logs in *ECS* (Elastic Common Schema) format, you can enter the following command:

<@kc.start parameters="--log-file-output=json --log-file-json-format=ecs"/>
...
<@kc.start parameters="--log-syslog-output=json --log-syslog-json-format=ecs"/>
