...
The more specific console handler configuration mentioned below will only take effect when the console logging is enabled (console logging is enabled by default).
