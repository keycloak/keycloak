...
NOTE: In an edge scenario where you do not wish to set proxy.headers, you must set proxy=edge as an additionalOption to override the implied default of proxy=passthrough. This will not be necessary in subsequent major releases.
