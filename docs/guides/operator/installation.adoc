...
Multi-namespace and cluster-wide installation is supported for common scenarios, but it is still considered in preview.
...
[WARNING]
====
This installation path is in preview and applies only to non-OLM installations.
