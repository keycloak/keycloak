...
* Version incompatibilities if custom resources use features from newer CRDs
* Breaking changes in the Operator behavior across major versions

*Recommendation:*

*We strongly recommend using only manual approval mode for the Keycloak Operator.* This ensures you can:
...
4. Review release notes and understand changes before approving upgrades

See the instructions below for configuring manual approval with OLM.
====
