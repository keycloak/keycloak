...
NOTE: if you will eventually want more than 1 server replica please see <@links.gettingstarted id="getting-started-scaling-tuning" anchor="horizontal-scaling" />.
