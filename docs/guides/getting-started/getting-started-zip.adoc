...
<@profile.ifCommunity>
After extracting this file, you should have a directory that is named `keycloak-{version}`.
</@profile.ifCommunity>

<@profile.ifProduct>
After extracting this file, you should have a directory that is named `rhbk-{version}`.
</@profile.ifProduct>
