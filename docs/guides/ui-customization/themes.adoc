...
* scripts: `media`, `integrity`, `defer`, `async`, `type`, `crossorigin`, `blocking`
...
NOTE: Resource ids must not contain dots, because dots separate the id from attribute names.
