...
The operator CRDs for the `Keycloak` and `KeycloakRealmImport` resources now include a v2beta1 version.
The v2alpha1 version for these resources is deprecated. There are currently no differences in the schema between the two versions,
