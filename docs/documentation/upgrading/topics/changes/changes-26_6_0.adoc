...
This change prevents the driver from automatically sending string parameters as Unicode unless explicitly required,which can reduce overhead and avoid unexpected performane or query-plan issues in some environments.
