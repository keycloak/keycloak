...
=== Database charset checks during startup
...
In the future, we may make it a hard requirement and {project_name} will not start if the proper encoding is not configured.
