...
The new procedure recommends to re-apply any changes to files in the `conf/` in case you modified any files in that directory, and leave them otherwise unchanged.
