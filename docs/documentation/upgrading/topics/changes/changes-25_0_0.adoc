...
Enabling this feature later, by a configuration change, can result in an unknown behavior and requires removal of all existing online user and client sessions before the first node is started with the feature enabled.
