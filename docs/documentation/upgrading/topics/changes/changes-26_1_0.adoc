...
The `db` option is now required to start and build commands. This is to prevent the unintentional usage of the `dev-file` (H2) database in a production environment.
