...
Starting from this release, {project_name} automatic enables the virtual thread pool support in both Infinispan and JGroups.
To disable, add one of the Java system properties combinations to your deployment:
