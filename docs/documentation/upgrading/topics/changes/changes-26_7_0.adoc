...
Identifiers like realm names, client scopes and client IDs can no longer contain characters that are also used as ANSI control characters. The character range 0x00-0x1F is no longer allowed.
Update your identifiers before upgrading.
