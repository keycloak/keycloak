...
The `OFFLINE_USER_SESSION` table has now updated indexes `IDX_USER_SESSION_EXPIRATION_CREATED`, `IDX_USER_SESSION_EXPIRATION_LAST_REFRESH` and `IDX_OFFLINE_USS_BY_BROKER_SESSION_ID`.
