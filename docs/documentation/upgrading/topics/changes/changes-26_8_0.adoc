...
If you have clients or automation that request the `delegation` scope, update them to use `delegation:user` instead. Existing realms will have the client scope renamed automatically during migration.
