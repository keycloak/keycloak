...
On databases that do not support non-blocking index creation, or when the migration strategy is set to `manual`, {project_name} continues to log the SQL statement for manual execution without creating the index automatically.
