...
If you use the `http challenge` flow for any of your clients, you may need to re-create the flow again after the migration to Keycloak 22. Make sure that you have Openshift extension
deployed as it contains needed authenticator providers.
