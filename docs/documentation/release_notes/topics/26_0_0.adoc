...
The native support for OpenTelemetry Tracing has been added to {project_name} and allows obtaining application traces for better observability.
...
The support is in the preview mode and we would be happy to obtain any feedback.
