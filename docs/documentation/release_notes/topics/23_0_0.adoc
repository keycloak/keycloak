...
= Changes to the hostname behavior for the Administration console

The hostname behavior for the Administration console has slightly changed.
When the `hostname-admin` or `hostname-admin-url` are not specified, the frontend URLs are used for the administration console.
