...
For newly created realms, the browser flow now includes the Recovery Authentication Code Form as _Disabled__, and it can be switched to _Alternative_ by admins if they want to use this feature.
