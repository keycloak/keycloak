...
== Keycloak Workflows (preview)

{project_name} introduces a new preview feature called {project_name} Workflows, which allows administrators to
...
For more details, see link:{adminguide_link}#_managing_workflows[{adminguide_name}].
