...
== x509cert-lookup SPI no longer internal

The x509cert-lookup SPI is no longer internal to allow for the creation of custom client certificate lookup.

Developers must take care to ensure that the source of the certificate is trusted.
