...
== Automate user provisioning with the SCIM API (supported)

In this release, the SCIM API is promoted from preview to supported.

https://datatracker.ietf.org/doc/html/rfc7644[SCIM] (System for Cross-domain Identity Management) is a standard protocol for reading and writing identity resources such as users and groups across multiple systems.
