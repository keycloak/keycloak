...
Client Secret Rotation enables confidential clients to rotate their secrets through client policies, allowing up to two concurrently active secrets for seamless rotation without downtime.
