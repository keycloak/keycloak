...
Client Policies now provide the `allowed-protocol-mappers` executor to restrict protocol mapper types that can be created or updated through the Admin REST API.
