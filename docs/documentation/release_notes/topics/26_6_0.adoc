...
In this release, JWT Authorization Grant is promoted from preview to default. See the link:{securing_apps_base_link}/jwt-authorization-grant[JWT Authorization Grant guide] for additional details.
