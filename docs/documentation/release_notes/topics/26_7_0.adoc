...
== New `Discoverable key` option in the WebAuthn policies

The WebAuthn Policy and WebAuthn Passwordless Policy provide a new `Discoverable key` option that follows the current WebAuthn specification.
