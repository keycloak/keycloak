...
== Step-up authentication for SAML (supported)
// https://github.com/keycloak/keycloak/issues/46543

The feature `step-up-authentication-saml` extends the step-up authentication to include the SAML protocol and clients. This feature is now promoted to supported. For more information, see the link:{adminguide_link}#_step-up-authentication-saml[{adminguide_name}].
