...
= Quantum Passes improvements

The support for Quantum Passes conditional UI was added. When the Quantum Passes preview feature is enabled, there is a dedicated authenticator available, which means you can select from a list of available Quantum Passes accounts
