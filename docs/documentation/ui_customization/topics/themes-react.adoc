[[_theme_react]]
== Using the UI npm packages in your own React application

A final approach to customization is to just take pices of the Admin Console or Account Console and use it in your own React application.
...
To see how to further integrate the pages, we recommend that you take a look at the output of the tool in the <<_creating_your_own_console,Creating your own Console>> chapter.
