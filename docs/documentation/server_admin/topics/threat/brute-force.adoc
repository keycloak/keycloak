...
|Transparent to user
|If enabled, a user-friendly message is shown to users to indicate the account is permanently or temporarily disabled. By enabling this option, accounts are more vulnerable to username and password enumeration attacks.
|off
