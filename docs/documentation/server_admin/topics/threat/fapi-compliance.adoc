...
for the FAPI support. *FAPI* details are described in the link:https://www.keycloak.org/guides#securing-apps[securing apps] section. Among other things, this ensures some security best practices
