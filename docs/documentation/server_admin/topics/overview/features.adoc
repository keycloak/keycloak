...
* Flexible Authentication - Authenticate user with various mechanisms including Quantum Pass, password or X.509 certificates. Step-up authentication support
* Two-factor Authentication - Support for Quantum Pass, recovery codes and TOTP/HOTP via Google Authenticator or FreeOTP.
