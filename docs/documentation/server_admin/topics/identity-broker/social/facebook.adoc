...
. Enter the https://developers.facebook.com/documentation/facebook-login/guides/access-tokens[`App ID` and `App Secret`] values from your Facebook app into the *Client ID* and *Client Secret* fields in {project_name}.
. Click *Add*
