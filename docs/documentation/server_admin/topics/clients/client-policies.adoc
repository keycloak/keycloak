...
* Enforce client URIs to comply with security criteria, for example to prevent SSRF attacks allowing only trusted patterns or domains. Check the <<ssrf,dedicated section>> for more details.
