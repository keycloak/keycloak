...
*OAuth2 Resource Owner Password Credentials Grant* in the link:https://www.keycloak.org/guides#securing-apps[securing apps] section and the confidential client `resource-owner`:
