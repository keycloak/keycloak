...
* You need to have the *view-groups* account role for being able to view *Groups* menu. For newly created realms, this role is automatically granted through the *manage-account* composite role.
