...
must be allowed to map roles to any user in the realm. Roles deleted before the invitation is accepted are not granted, and
resending an invitation keeps the roles that still exist.
