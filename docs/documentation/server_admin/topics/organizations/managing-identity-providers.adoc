...
Group::
The group to assign users to. If the IdP is linked to an organization, you can select groups from that organization. Only groups belonging to the linked organization are available.
