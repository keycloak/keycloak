...
on the user and `manage-membership-of-members` on the group.
...
| *manage-membership-of-members* | Defines if a realm administrator can assign or unassign specific users to or from a group.
|===
