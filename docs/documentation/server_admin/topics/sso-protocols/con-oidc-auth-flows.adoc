...
return new refresh tokens. This practice is recommended for instance in the *FAPI 2 draft specification* in the link:https://www.keycloak.org/guides#securing-apps[securing apps] section.
