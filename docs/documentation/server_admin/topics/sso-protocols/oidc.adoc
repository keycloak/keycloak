...
Also please refer to other places of {project_name} documentation like *Backchannel Authentication Endpoint* and *Client Initiated Backchannel Authentication Grant* in the link:https://www.keycloak.org/guides#securing-apps[securing apps] section.
