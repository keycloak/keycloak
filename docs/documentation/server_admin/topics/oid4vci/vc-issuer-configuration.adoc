...
- **preAuthorizedCodeLifespanS** – Defines how long credential offers remain valid (in seconds). This lifespan applies to both the authorization code and pre-authorized code grant flows.
