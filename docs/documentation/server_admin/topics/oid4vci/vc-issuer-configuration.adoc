...
This guide covered the basic configuration. For more advanced topics, see:

- <<_oid4vci_proofs, Proof Types and Key Binding>> - Detailed documentation on proof types, creating JWT proofs, configuring trusted attestation keys, and how key binding appears in credentials.
