...
| Comma-separated cryptographic binding methods. Default value is `jwk`, which is only supported method for the formats like SD-JWT VC or JWT VC. Different methods might be possible for other formats (like mdoc).
