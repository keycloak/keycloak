...
----
{
  ...
  "credential_configurations_supported": {
    "my-credential-configuration-id": {
      "format": "jwt_vc_json",
      "scope": "vc-scope-mapping",
...
GET /realms/{realm}/protocol/openid-connect/auth
  ...
  &redirect_uri=https://wallet.example.com/callback
  &scope=openid
  &authorization_details=%5B%7B%22type%22%3A%22openid_credential%22%2C%22credential_configuration_id%22%3A%22my-credential-configuration-id%22%7D%5D
  &code_challenge=xyz...
  &code_challenge_method=S256
----
...
curl -X POST "https://localhost:8443/realms/{realm}/protocol/oid4vc/credential" \
  ...
  -d '{
    "credential_identifier": "my-credential-identifier",
    "proofs": {
      "jwt": [
