...
Allow UTF-8::
  Option to allow UTF-8 strings in message headers, for example in addresses. This should only be enabled if the mail server also supports UTF-8 (SMTPUTF8 extension).
