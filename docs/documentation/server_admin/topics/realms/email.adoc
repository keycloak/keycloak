...
. Confirm that the *Email* field is populated with the user's email address.
...
.Result
Once the user clicks the verification link in the email, the *Email Verified* field in their account is set to *Yes*.
