...
The server's root `themes` directory does not contain any themes by default, but it contains README file with some additional details about the default themes.
