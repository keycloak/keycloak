...
of the authentication flow and encapsulate the existing authenticators into a separate REQUIRED authenticator. This need is because the REQUIRED and ALTERNATIVE executions
