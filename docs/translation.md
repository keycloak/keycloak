...
See here for a [list of all translations available in Weblate and their status](https://www.keycloak.org/translations).

If you have any questions or need assistance, feel free to reach out to the language maintainers listed in [the language maintainers file](../.github/language-maintainers.yml).
...
- English: `js/apps/account-ui/maven-resources/theme/keycloak.v4/account/messages/messages_en.properties`
- Translations: `js/apps/account-ui/maven-resources-community/theme/keycloak.v4/account/messages/messages_<lang>.properties`
...
- The Keycloak-Team will then
    ...
    - on GitHub:
      ...
      - Update [the language maintainers file](../.github/language-maintainers.yml) with the GitHub handles of the language mainatainers to enable notifications on updated files on GitHub.
      - If it is a language that wasn't translated before, update the `theme.properties` files to include the new language.
