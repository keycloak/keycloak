...
public class ClientSupplier implements Supplier<ClientResource, Client> {

    private static final String CLIENT_UUID_KEY = "clientUuid";

    @Override
    public Class<Client> getAnnotationClass() {
        return Client.class;
    }
    ...
    @Override
    public ClientResource getValue(InstanceContext<ClientResource, Client> instanceContext) {
    ...
    @Override
    public boolean compatible(InstanceContext<ClientResource, Client> a, RequestedInstance<ClientResource, Client> b) {
        return a.getAnnotation().config().equals(b.getAnnotation().config());
    }

    @Override
    public void close(InstanceContext<ClientResource, Client> instanceContext) {
