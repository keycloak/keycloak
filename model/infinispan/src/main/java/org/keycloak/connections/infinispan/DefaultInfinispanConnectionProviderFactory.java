...
import static org.keycloak.models.sessions.infinispan.util.InfinispanUtil.setTimeServiceToKeycloakTime;
    ...
    protected void initEmbedded() {
        ...
        if (clustered) {
            ...
            configureTransport(gcb, topologyInfo.getMyNodeName(), topologyInfo.getMySiteName(), jgroupsUdpMcastAddr,
                    "default-configs/default-keycloak-jgroups-udp.xml", this.getClass().getClassLoader());
            gcb.jmx()
