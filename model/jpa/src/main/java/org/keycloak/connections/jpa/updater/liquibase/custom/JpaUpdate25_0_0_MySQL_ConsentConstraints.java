...
public class JpaUpdate25_0_0_MySQL_ConsentConstraints extends CustomKeycloakTask {
    ...
    protected void generateStatementsImpl() throws CustomChangeException {
        ...
        statements.add(new RawParameterizedSqlStatement("DROP TABLE IF EXISTS TEMP_USER_CONSENT_IDS"));
        ...
        statements.add(new RawParameterizedSqlStatement("DROP TABLE IF EXISTS TEMP_USER_CONSENT_IDS2"));
    }
