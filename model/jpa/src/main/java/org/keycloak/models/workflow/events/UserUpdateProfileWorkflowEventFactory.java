...
public class UserUpdateProfileWorkflowEventFactory implements WorkflowEventProviderFactory<WorkflowEventProvider> {

    public static final String ID = "user-update-profile";

    @Override
    public WorkflowEventProvider create(KeycloakSession session, String configParameter) {
        return new UserUpdateProfileWorkflowEventProvider(session, configParameter, this.getId());
    }
