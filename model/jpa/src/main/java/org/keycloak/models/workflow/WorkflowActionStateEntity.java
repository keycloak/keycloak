 ...
 */
@Entity
@Table(name = "WORKFLOW_ACTION_STATE")
@IdClass(WorkflowActionStateEntity.PrimaryKey.class)
public class WorkflowActionStateEntity {
    ...
    public void setWorkflowProviderId(String policyProviderId) {
        this.workflowProviderId = policyProviderId;
    }
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        WorkflowActionStateEntity that = (WorkflowActionStateEntity) o;
        return Objects.equals(resourceId, that.resourceId) && Objects.equals(workflowId, that.workflowId);
    }
