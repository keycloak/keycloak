...
@NamedQueries({
        ...
        @NamedQuery(name="getGroupIdsByParentAndNameContaining", query="select u.id from GroupEntity u where u.realm = :realm and u.parentId = :parent and u.name like concat('%',:search,'%') order by u.name ASC"),
