...
public class UserUpdateConsentWorkflowEventFactory implements WorkflowEventProviderFactory<WorkflowEventProvider> {

    public static final String ID = "user-update-consent";

    @Override
    public WorkflowEventProvider create(KeycloakSession session, String configParameter) {
        return new UserUpdateConsentWorkflowEventProvider(session, configParameter, this.getId());
    }
