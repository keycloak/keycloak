...
@NamedQueries({
        ...
        @NamedQuery(name="getClientRolesCount", query="select count(role) from RoleEntity role where role.type = 'CLIENT' and role.clientId = :client"),
        @NamedQuery(name="searchForClientRolesCount", query="select count(role) from RoleEntity role where role.type = 'CLIENT' and role.clientId = :client and ( lower(role.name) like :search or lower(role.description) like :search )"),
        ...
        @NamedQuery(name="getRealmRolesCount", query="select count(role) from RoleEntity role where role.type = 'REALM' and role.realmId = :realm"),
        @NamedQuery(name="searchForRealmRolesCount", query="select count(role) from RoleEntity role where role.type = 'REALM' and role.realmId = :realm and ( lower(role.name) like :search or lower(role.description) like :search )"),
        ...
        @NamedQuery(name="getRoleDetailsByIds", query="select role.id, role.name, role.type, role.clientId, role.realmId, role.organizationId from RoleEntity role where role.id in :roleIds"),
        @NamedQuery(name="getRoleDetailsByRealmAndNames", query="select role.id, role.name, role.type, role.clientId, role.realmId, role.organizationId from RoleEntity role where role.realmId = :realmId and role.name in :roleNames"),
