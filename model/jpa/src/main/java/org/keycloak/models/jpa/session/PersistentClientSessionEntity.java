...
@NamedQueries({
        ...
        @NamedQuery(name="deleteDetachedClientSessionsCrossRealm", query="delete from PersistentClientSessionEntity sess where sess.userSessionId NOT IN (select u.userSessionId from PersistentUserSessionEntity u where u.offline = :offline)"),
