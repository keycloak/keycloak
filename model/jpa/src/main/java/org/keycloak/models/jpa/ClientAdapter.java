    ...
    */
    ...
    public class ClientAdapter implements ClientModel, JpaModel<ClientEntity> {
        ...
        public boolean isSelectiveConsent() {
            return entity.isSelectiveConsent();
        }
        ...
        public String getSelectiveConsentAttributeKey() {
            return entity.getSelectiveConsentAttributeKey();
        }

        @Override
        public String getSelectiveConsentAttributeValue() {
            return entity.getSelectiveConsentAttributeValue();
        }


        @Override
        public void setSelectiveConsentAttributeKey(String selectiveConsentAttributeKey) {
            entity.setSelectiveConsentAttributeKey(selectiveConsentAttributeKey);
        }

        @Override
        public void setSelectiveConsentAttributeValue(String selectiveConsentAttributeValue) {
            entity.setSelectiveConsentAttributeValue(selectiveConsentAttributeValue);
        }
