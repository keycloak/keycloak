...
public class PolicyEntity {
    ...
    private List<PermissionTicketEntity> permissionTicketEntities;
    ...
    public List<PermissionTicketEntity> getPermissionTicketEntities() {
        return permissionTicketEntities;
    }
