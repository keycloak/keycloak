...
of all known Liquibase ChangeSets in this module are recorded using the `db-compatibility-verifier:create-snapshot`
...
The `db-compatibility-verifier:verify-compatibility` plugin is used as part of the `model/jpa` test phase to ensure that
