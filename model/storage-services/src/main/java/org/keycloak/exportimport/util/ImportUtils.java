...
public class ImportUtils {
    ...
    public static void importUsersFromStream(KeycloakSession session, String realmName, ObjectMapper mapper, InputStream is, boolean federated, Runnable onUserCreated) throws IOException {
        RealmProvider model = session.realms();
