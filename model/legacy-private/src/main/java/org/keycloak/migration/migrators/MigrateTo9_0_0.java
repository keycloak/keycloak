...
public class MigrateTo9_0_0 implements Migration {
    ...
    protected void addAccountClient(RealmModel realm) {
        if (realm.getClientByClientId(Constants.ACCOUNT_MANAGEMENT_CLIENT_ID) == null) {
            ClientModel client = KeycloakModelUtils.createPublicClient(realm, Constants.ACCOUNT_MANAGEMENT_CLIENT_ID);
