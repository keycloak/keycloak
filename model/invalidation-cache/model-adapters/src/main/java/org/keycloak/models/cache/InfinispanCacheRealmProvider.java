 ...
 */
public class InfinispanCacheRealmProvider implements CacheRealmProvider {
    ...
    public InfinispanCacheRealmProvider(RealmCache cache, KeycloakSession session) {
        this.cache = cache;
    ...
    public RoleModel getRoleById(String id, RealmModel realm) {
        ...
        CachedRole cached = (CachedRole) cache.getRole(id);
