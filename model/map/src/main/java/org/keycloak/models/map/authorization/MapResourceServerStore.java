...
public class MapResourceServerStore implements ResourceServerStore {
    ...
    private Function<MapResourceServerEntity, ResourceServer> entityToAdapterFunc() {
        // Clone entity before returning back, to avoid giving away a reference to the live object to the caller
        return origEntity -> new MapResourceServerAdapter(origEntity, authorizationProvider.getStoreFactory());
    }
    ...
    public ResourceServer create(ClientModel client) {
        ...
        return entityToAdapterFunc().apply(entity);
    }
    ...
    public ResourceServer findById(String id) {
        ...
        return entity == null ? null : entityToAdapterFunc().apply(entity);
    }
    ...
    public ResourceServer findByClient(ClientModel client) {
        ...
        return tx.read(withCriteria(mcb)).map(entityToAdapterFunc()).findFirst().orElse(null);
    }
}
