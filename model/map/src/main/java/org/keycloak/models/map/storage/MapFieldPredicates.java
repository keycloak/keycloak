...
public class MapFieldPredicates {
    ...
    static {
        ...
        put(CLIENT_PREDICATES, ClientModel.SearchableFields.SCOPE_MAPPING_ROLE,   MapClientEntity::getScopeMappings);
        ...
        put(GROUP_PREDICATES, GroupModel.SearchableFields.ASSIGNED_ROLE,          MapGroupEntity::getGrantedRoles);
        ...
        put(USER_PREDICATES, UserModel.SearchableFields.ASSIGNED_ROLE,            MapUserEntity::getRolesMembership);
        put(USER_PREDICATES, UserModel.SearchableFields.ASSIGNED_GROUP,           MapUserEntity::getGroupsMembership);
        ...
        put(AUTHZ_RESOURCE_PREDICATES, Resource.SearchableFields.URI, MapResourceEntity::getUris);
        put(AUTHZ_RESOURCE_PREDICATES, Resource.SearchableFields.SCOPE_ID, MapResourceEntity::getScopeIds);
        ...
        put(AUTHZ_POLICY_PREDICATES, Policy.SearchableFields.RESOURCE_ID, MapPolicyEntity::getResourceIds);
        put(AUTHZ_POLICY_PREDICATES, Policy.SearchableFields.SCOPE_ID, MapPolicyEntity::getScopeIds);
        put(AUTHZ_POLICY_PREDICATES, Policy.SearchableFields.CONFIG, MapFieldPredicates::checkPolicyConfig);
        put(AUTHZ_POLICY_PREDICATES, Policy.SearchableFields.ASSOCIATED_POLICY_ID, MapPolicyEntity::getAssociatedPoliciesIds);
        ...
        put(USER_SESSION_PREDICATES, UserSessionModel.SearchableFields.CLIENT_ID,                 use -> use.getAuthenticatedClientSessions().keySet());
    ...
    private static String ensureHasValueOpAndSingleValue(SearchableModelField<?> field, String parameterName, Operator op, Object[] values) throws CriterionNotSupportedException {
        return ensureHasValueOpAndSingleValue(field, parameterName, op, values, String.class);
    }

    private static <T> T ensureHasValueOpAndSingleValue(SearchableModelField<?> field, String parameterName, Operator op, Object[] values, Class<T> expectedType) throws CriterionNotSupportedException {
        if (op != Operator.HAS_VALUE) {
    ...
    private static MapModelCriteriaBuilder<Object, MapUserEntity<Object>, UserModel> getUserConsentClientFederationLink(MapModelCriteriaBuilder<Object, MapUserEntity<Object>, UserModel> mcb, Operator op, Object[] values) {
        String providerId = ensureHasValueOpAndSingleValue(UserModel.SearchableFields.CONSENT_CLIENT_FEDERATION_LINK, "provider_id", op, values);
