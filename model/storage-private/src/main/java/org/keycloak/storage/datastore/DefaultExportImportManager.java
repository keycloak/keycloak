    ...
    public void updateRealm(RealmRepresentation rep, RealmModel realm) {
        ...
        if (rep.getSmtpServer() != null) {
            ...
            if(rep.getSmtpServer().containsKey("authType") && "basic".equals(rep.getSmtpServer().get("authType"))) {
                ...
                rep.getSmtpServer().remove("authTokenUrl");
                rep.getSmtpServer().remove("authTokenScope");
                rep.getSmtpServer().remove("authTokenClientId");
                rep.getSmtpServer().remove("authTokenClientSecret");
            }
            ...
            if(rep.getSmtpServer().containsKey("authType") && "token".equals(rep.getSmtpServer().get("authType"))) {
                ...
                rep.getSmtpServer().remove("password");
            }
