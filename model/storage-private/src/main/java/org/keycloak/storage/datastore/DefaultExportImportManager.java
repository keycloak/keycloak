...
public class DefaultExportImportManager implements ExportImportManager {
    ...
    public void importRealm(RealmRepresentation rep, RealmModel newRealm, boolean skipUserDependent) {
        ...
        if (rep.isTransparentUserMessage() != null) newRealm.setTransparentUserMessage(rep.isTransparentUserMessage());
    ...
    public void updateRealm(RealmRepresentation rep, RealmModel realm) {
        ...
        if (rep.isTransparentUserMessage() != null) realm.setTransparentUserMessage(rep.isTransparentUserMessage());
