...
public class IDTokenResponseRequest extends AbstractHttpPostRequest<IDTokenResponseRequest, AuthorizationEndpointResponse> {
    ...
    @Override
    protected AuthorizationEndpointResponse toResponse(CloseableHttpResponse response) throws IOException {
