...
public class IssuerInitiatedBatchIssuanceTest extends AbstractNonHaipVciConformanceTest {

    @InjectRealm(config = IssuerBatchIssuanceTest.BatchIssuanceRealmConfig.class, lifecycle = LifeCycle.METHOD)
    ManagedRealm realm;
