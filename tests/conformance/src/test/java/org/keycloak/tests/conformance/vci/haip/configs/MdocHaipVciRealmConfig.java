...
import static org.keycloak.tests.conformance.vci.haip.configs.HaipVciRealmConfig.attesterTrustIdentityProvider;
import static org.keycloak.tests.conformance.vci.haip.configs.HaipVciRealmConfig.haipClientPolicy;
import static org.keycloak.tests.conformance.vci.haip.configs.HaipVciRealmConfig.haipClientProfile;
import static org.keycloak.tests.conformance.vci.haip.configs.HaipVciRealmConfig.haipConformanceClient;

public class MdocHaipVciRealmConfig implements RealmConfig {

    @Override
    public RealmBuilder configure(RealmBuilder realm) {
        return VciConformanceRealmUtil.applyCommon(realm, true)
                .clients(haipConformanceClient(CLIENT, false, true),
                        haipConformanceClient(CLIENT2, true, true),
