...
public class ProfileAssume {
    ...
    public static void assumeFeatureEnabled(Profile.Feature feature) {
        Assumptions.assumeTrue(isFeatureEnabled(feature), "Ignoring test as feature " + feature.getKey() + " is not enabled");
    }

    public static void assumeFeatureDisabled(Profile.Feature feature) {
        Assumptions.assumeTrue(!isFeatureEnabled(feature), "Ignoring test as feature " + feature.getKey() + " is enabled");
    }

    public static boolean isFeatureEnabled(Profile.Feature feature) {
        return DISABLED_FEATURES == null || !DISABLED_FEATURES.contains(feature);
    }
