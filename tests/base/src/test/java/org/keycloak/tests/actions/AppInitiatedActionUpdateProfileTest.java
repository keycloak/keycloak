...
public class AppInitiatedActionUpdateProfileTest extends AbstractAppInitiatedActionTest {
    ...
    @InjectRealm(config = AppInitiatedActionUpdateProfileRealmConfig.class)
    ...
    private static class AppInitiatedActionUpdateProfileRealmConfig extends LegacyRealmConfig {
