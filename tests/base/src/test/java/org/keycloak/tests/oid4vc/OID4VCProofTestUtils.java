...
public final class OID4VCProofTestUtils {
    ...
    // RSA-only: the signing key pair here always comes from an RSA test key generator in this
    // class, so the algorithm is fixed rather than derived from the key type.
