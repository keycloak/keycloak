...
public class KcOidcBrokerJWEEcdhEsA256KwP521A256GcmTest implements EcdhEsJweBrokerConfigSupport, JweUserInfoBrokerTest, BrokerLoginTest {
    ...
    @Override public String getCurve() { return "P-521"; }
    @Override public String getEncAlg() { return JWEConstants.ECDH_ES_A256KW; }
    @Override public String getEncEnc() { return JWEConstants.A256GCM; }
    @Override public String getSigAlg() { return Algorithm.ES512; }
