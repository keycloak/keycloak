...
public class OrganizationInvitationThemeTest extends AbstractOrganizationTest {
    ...
    // the domain must not match the organization domain, otherwise the organization resolves from the email
    // address alone and the test no longer tells us anything about the invitation
    private static final String INVITEE_EMAIL = "invited@myemail.com";
    ...
    public void testOrganizationAvailableWhenConfirmingMembership() throws IOException {
        ...
        String page = driver.page().getPageSource();
