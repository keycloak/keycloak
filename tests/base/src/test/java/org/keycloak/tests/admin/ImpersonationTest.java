...
public class ImpersonationTest {
    ...
    @InjectUser(ref = "admin", realmRef = "master", config = MasterAdminUserConfig.class)
    ...
    public void testImpersonationBySameRealmServiceAccount() throws Exception {
        ...
        ApiUtil.assignClientRoles(managedRealm.admin(), user.getId(), Constants.REALM_MANAGEMENT_CLIENT_ID, ImpersonationConstants.IMPERSONATION_ROLE);
    ...
    private static class ImpersonationTestRealmConfig implements RealmConfig {
        ...
        public RealmConfigBuilder configure(RealmConfigBuilder config) {
            ...
            config.addUser("impersonator")
                    ...
                    .clientRoles(Constants.REALM_MANAGEMENT_CLIENT_ID, ImpersonationConstants.IMPERSONATION_ROLE)
