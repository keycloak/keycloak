...
public class OrganizationIdentityProviderLinkTest extends AbstractOrganizationTest {
    ...
    private OrganizationIdentityProviderLinkRepresentation getOrgLink(IdentityProviderRepresentation idpRep, String orgId) {
        assertNotNull(idpRep.getOrganizationLinks());
        return idpRep.getOrganizationLinks().stream()
                .filter(l -> orgId.equals(l.getOrganizationId()))
                .findFirst()
                .orElseThrow(() -> new AssertionError("No organization link found for org " + orgId));
    }
    ...
    public void testDefaultLinkConfig() {
        ...
        OrganizationIdentityProviderLinkRepresentation link = getOrgLink(idpRep, org.getId());
        assertNotNull(link.getAutoMembership());
        assertTrue(link.getAutoMembership());
        assertEquals("UNMANAGED", link.getMembershipType());
    }
    ...
    public void testUpdateLinkConfig() {
        ...
        OrganizationIdentityProviderLinkRepresentation updatedLink = getOrgLink(updated, org.getId());
        assertTrue(updatedLink.getAutoMembership());
        assertEquals("MANAGED", updatedLink.getMembershipType());
    }
    ...
    public void testUpdateToUnmanaged() {
        ...
        IdentityProviderRepresentation updated = idpResource.toRepresentation();
        OrganizationIdentityProviderLinkRepresentation updatedLink = getOrgLink(updated, org.getId());
        assertEquals(false, updatedLink.getAutoMembership());
        assertEquals("UNMANAGED", updatedLink.getMembershipType());
    }
    ...
    public void testRejectAmFalseWithManaged() {
        ...
        OrganizationIdentityProviderLinkRepresentation unchangedLink = getOrgLink(unchanged, org.getId());
        assertTrue(unchangedLink.getAutoMembership());
        assertEquals("UNMANAGED", unchangedLink.getMembershipType());
    }
    ...
    public void testListIncludesLinkConfig() {
        ...
        OrganizationIdentityProviderLinkRepresentation foundLink = getOrgLink(found, org.getId());
        assertTrue(foundLink.getAutoMembership());
        assertEquals("MANAGED", foundLink.getMembershipType());
    }
