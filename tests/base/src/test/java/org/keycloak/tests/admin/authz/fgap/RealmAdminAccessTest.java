...
public class RealmAdminAccessTest extends AbstractPermissionTest {
    ...
    public void testRolePolicyRespectsClientScope() {
        ...
        ClientRepresentation fullScopeClient = ClientConfigBuilder.create().clientId("full-scope-client")
                .publicClient(true)
        ...
        ClientRepresentation restrictedClient = ClientConfigBuilder.create().clientId("restricted-client")
                .publicClient(true)
                .directAccessGrantsEnabled(true)
    ...
    public void testClientRolePolicyRespectsClientScope() {
        ...
        ClientRepresentation customApp = ClientConfigBuilder.create().clientId("custom-app")
                .publicClient(true)
                .directAccessGrantsEnabled(true)
                .build();
