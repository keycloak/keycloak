...
public class LoginSSLTest {
    ...
    public void loginSuccessRealmSigningAlgorithms() throws JWSInputException {
        managedRealm.updateUserWithCleanup("login-test", user -> user.password("test"));
        String userId = AdminApiUtil.findUserByUsername(managedRealm.admin(), "login-test").getId();
