    ...
    public void testRestEvaluation() throws Exception {
...

        {
            try (Keycloak realmClient = adminClientFactory.create().realm(REALM_NAME)
                ...
                try {
                    ApiUtil.createUserWithAdminClient(realmClient.realm(REALM_NAME), newGroupMemberWithoutGroup);
                ...
                try {
                    ApiUtil.createUserWithAdminClient(realmClient.realm(REALM_NAME), newEmptyGroupList);
                    Assertions.fail("should fail with HTTP response code 403 Forbidden");
                } catch (WebApplicationException e) {
                    Assertions.assertEquals(403, e.getResponse().getStatus());
                }
                ...
                try {
                    ApiUtil.createUserWithAdminClient(realmClient.realm(REALM_NAME), newGroupMemberWithNonExistentGroup);
                    Assertions.fail("should fail with HTTP response code 403 Forbidden");
                } catch (WebApplicationException e) {
                    Assertions.assertEquals(403, e.getResponse().getStatus());
                }
                ...
                try {
                    ApiUtil.createUserWithAdminClient(realmClient.realm(REALM_NAME), newGroupMemberOfNotManagedGroup);
                    Assertions.fail("should fail with HTTP response code 403 Forbidden");
                } catch (WebApplicationException e) {
                    Assertions.assertEquals(403, e.getResponse().getStatus());
                }
