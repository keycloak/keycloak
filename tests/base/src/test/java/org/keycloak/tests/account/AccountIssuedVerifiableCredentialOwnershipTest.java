...
public class AccountIssuedVerifiableCredentialOwnershipTest {
    ...
    @InjectRealm(ref = "ownership-test-realm", config = OwnershipTestRealmConfig.class)
    ManagedRealm realm;

    @InjectOAuthClient(realmRef = "ownership-test-realm", config = AccountIssuedVerifiableCredentialOwnershipTest.AccountClientConfig.class)
    OAuthClient oauth;
    ...
    private void createIssuedVcViaModelLayer(String userId, String credentialType,
        ...
        runOnServer.run(session -> {
            ...
            UserVerifiableCredentialModel vcModel = new UserVerifiableCredentialModel(vcId, clientScopeId);
    ...
    public static class AccountClientConfig implements ClientConfig {
        @Override
        public ClientBuilder configure(ClientBuilder client) {
            ProtocolMapperRepresentation audienceMapper = new ProtocolMapperRepresentation();
            audienceMapper.setName("account-audience");
            ...
            audienceConfig.put(AudienceProtocolMapper.INCLUDED_CLIENT_AUDIENCE, Constants.ACCOUNT_MANAGEMENT_CLIENT_ID);
