...
public class KcOidcBrokerConfiguration implements BrokerConfiguration {
    ...
    public List<ClientRepresentation> createProviderClients() {
        ...
        client.setRedirectUris(Collections.singletonList(getConsumerRoot() +
                getAuthPath() + "/realms/" + consumerRealmName() + "/broker/" + getIDPAlias() + "/endpoint/*"));
        ...
        oidcClient.setBackchannelLogoutUrl(getConsumerRoot() +
                getAuthPath() + "/realms/" + consumerRealmName() + "/protocol/openid-connect/logout/backchannel-logout");
    ...
    public List<ClientRepresentation> createConsumerClients() {
        ...
        client.setBaseUrl(getConsumerRoot() +
                getAuthPath() + "/realms/" + REALM_CONS_NAME + "/app");
    ...
    protected void applyDefaultConfiguration(final Map<String, String> config, IdentityProviderSyncMode syncMode) {
        ...
        config.put(OIDCIdentityProviderConfig.ISSUER, getProviderRoot() + getAuthPath() + "/realms/" + REALM_PROV_NAME);
        config.put("authorizationUrl", getProviderRoot() + getAuthPath() + "/realms/" + REALM_PROV_NAME + "/protocol/openid-connect/auth");
        config.put(TOKEN_ENDPOINT_URL, getProviderRoot() + getAuthPath() + "/realms/" + REALM_PROV_NAME + "/protocol/openid-connect/token");
        config.put("logoutUrl", getProviderRoot() + getAuthPath() + "/realms/" + REALM_PROV_NAME + "/protocol/openid-connect/logout");
        config.put("userInfoUrl", getProviderRoot() + getAuthPath() + "/realms/" + REALM_PROV_NAME + "/protocol/openid-connect/userinfo");
        config.put("defaultScope", "email profile");
        config.put("backchannelSupported", "true");
        config.put(OIDCIdentityProviderConfig.JWKS_URL,
                getProviderRoot() + getAuthPath() + "/realms/" + REALM_PROV_NAME + "/protocol/openid-connect/certs");
