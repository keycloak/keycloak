...
public class AdminClientTest {
    ...
    public void adminAuthCloseUserSession() {
        UserResource user = ApiUtil.findUserByUsernameId(testRealm.admin(), TEST_USER_USERNAME);
    ...
    public void scopedClientCredentialsAuthSuccess() {
        ...
        ApiUtil.findClientByClientId(testRealm.admin(), CLIENT_ID).addOptionalClientScope(scopeId);
    ...
    @Test
    @Disabled // todo mTLS not implemented yet
...
//        }
    ...
    private void setUserEnabled(String username, boolean enabled) {
        UserResource user = ApiUtil.findUserByUsernameId(testRealm.admin(), username);
    ...
    private void setClientEnabled(String clientId, boolean enabled) {
        ClientResource client = ApiUtil.findClientByClientId(testRealm.admin(), clientId);
