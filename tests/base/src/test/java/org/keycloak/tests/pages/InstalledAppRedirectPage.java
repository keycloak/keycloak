...
package org.keycloak.tests.pages;
...
public class InstalledAppRedirectPage extends AbstractPage {
    ...
    public void open(String realmName, String code, String error, String errorDescription, String oAuthServerRoot) {
        try {
            KeycloakUriBuilder kcUriBuilder = KeycloakUriBuilder.fromUri(Urls.realmInstalledAppUrnCallback(new URI(oAuthServerRoot), realmName));
            if (code != null) {
