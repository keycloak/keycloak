...
public class AppInitiatedActionTest extends AbstractActionsTest {

    private static final String SUCCESS = "success";

    @InjectRealm(config = AppInitiatedActionRealmConfig.class)
    ...
    private static class AppInitiatedActionRealmConfig extends LegacyRealmConfig {
