...
public class KcOidcBrokerPrivateKeyJwtCustomAudienceTest implements BrokerLoginTest, KcOidcBrokerConfigSupport {
        ...
        public RealmBuilder configure(RealmBuilder realm) {
            return KcOidcBrokerConfigSupport.configureConsumerRealm(realm,
                    KcOidcBrokerConfigSupport.createOidcIdentityProvider()
                            ...
                            .attribute("clientAssertionAudience",
                                    "http://localhost:8080/realms/" + PROVIDER_REALM));
        }
    }
}
