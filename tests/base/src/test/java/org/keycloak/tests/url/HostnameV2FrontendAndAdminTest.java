...
@KeycloakIntegrationTest(config = HostnameV2FrontendAndAdminTest.ServerConfig.class)
class HostnameV2FrontendAndAdminTest {

    private static final String FIXED_FRONTEND_URL = "http://localtest.me:444";
    ...
    void testFrontendAndBackendUrls() {
        assertFrontendAndBackendUrls(oAuthClient, "master", FIXED_FRONTEND_URL, FIXED_FRONTEND_URL);
    }

    @Test
    void testAdminUrls() throws IOException {
        assertAdminUrls(simpleHttp, keycloakUrls, "master", FIXED_FRONTEND_URL, FIXED_ADMIN_URL);
    }
