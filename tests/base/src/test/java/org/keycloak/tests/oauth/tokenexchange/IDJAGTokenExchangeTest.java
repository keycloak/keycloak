...
public class IDJAGTokenExchangeTest {
    ...
    public static class SSODomainConfig implements RealmConfig {
        ...
        public RealmBuilder configure(RealmBuilder realm) {
            ...
            realm.clients(ClientBuilder.create().clientId("agent_missing_scope")
                    .secret("password")
                    .redirectUris("*")
                    .attribute("standard.token.exchange.enabled", "true")
                    .attribute("idjag.clientid.at.todo","agent-at-todo"));
    ...
    @Test
    public void testTokenExchangeFailsWithInvalidScope() throws Exception {
    ...
    @Test
    public void testTokenExchangeFailsWhenPermittedScopesNotConfigured() {
        ...
        oauth.realm("ssodomain").client("agent_missing_scope", "password").openLoginForm();
        oauth.fillLoginForm("testuser", "password");
        ...
        Assertions.assertFalse(tokenResponse.isSuccess());
        Assertions.assertEquals(400, tokenResponse.getStatusCode(), "Expected 400 Bad Request for unpermitted scope");
        Assertions.assertNull(tokenResponse.getAccessToken());
        Assertions.assertEquals(OAuthErrorException.INVALID_SCOPE, tokenResponse.getError());
        Assertions.assertEquals("Permitted scopes not configured for the audience client", tokenResponse.getErrorDescription());
    }
