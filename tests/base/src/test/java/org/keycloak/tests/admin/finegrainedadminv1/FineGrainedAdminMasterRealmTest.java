...
public class FineGrainedAdminMasterRealmTest extends AbstractFineGrainedAdminTest {
    ...
    public void testMasterRealm() throws Exception {
        ...
        ClientRepresentation client = managedRealm.admin().clients().findClientByClientId(CLIENT_NAME);
    ...
    public void testMasterRealmWithComposites() throws Exception {
        ...
        ClientRepresentation client = managedRealm.admin().clients().findClientByClientId(Constants.REALM_MANAGEMENT_CLIENT_ID);
