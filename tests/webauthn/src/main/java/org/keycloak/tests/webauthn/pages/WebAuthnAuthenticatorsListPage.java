 ...
 */
public class WebAuthnAuthenticatorsListPage extends AbstractPage {

    @FindBy(xpath = "//div[contains(@id,'kc-webauthn-authenticator-item-')]")
    private List<WebElement> authenticators;

    public WebAuthnAuthenticatorsListPage(WebDriver driver) {
        super(driver);
    }

    @Override
    public String getExpectedPageId() {
        return "kc-webauthn-authenticator-item";
    }
