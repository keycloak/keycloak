...
public class QuarkusKeycloakApplication extends KeycloakApplication {
    ...
    private static final String KEYCLOAK_ADMIN_IS_TEMPORARY = "KEYCLOAK_ADMIN_IS_TEMPORARY";
    ...
    protected void createTemporaryAdmin(KeycloakSession session) {
        ...
        var isTemporary = Boolean.parseBoolean(getOption(BootstrapAdminOptions.IS_TEMPORARY.getKey(), KEYCLOAK_ADMIN_IS_TEMPORARY));
