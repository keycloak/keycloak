...
public class QuarkusKeycloakApplication extends KeycloakApplication {
    ...
    protected void createTemporaryAdmin(KeycloakSession session) {
        ...
        try {
            Integer expiration = Optional.ofNullable(getEnvOrProp(BootstrapAdmin.KEYCLOAK_BOOTSTRAP_ADMIN_EXPIRATION_ENV_VAR)).map(Integer::valueOf).orElse(null);
    ...
    private String getEnvOrProp(String envKey) {
        return getEnvOrProp(envKey, envKey.toLowerCase().replace("_", "."));
    }
