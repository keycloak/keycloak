...
public final class QuarkusHttpRequest implements HttpRequest {
    ...
    public HttpHeaders getHttpHeaders() {
        ...
        // trigger the proxy handling prior to getting the headers
        // so that quarkus will normalize / populate additional headers
        // see https://github.com/quarkusio/quarkus/issues/46617
        context.serverRequest().getRequestScheme();
