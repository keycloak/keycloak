...
/**
 * Interceptor that updates socket timeout when connections are created.
 * This prevents hanging connections by ensuring proper timeout configuration.
 * 
 * @see <a href="https://github.com/keycloak/keycloak/issues/47839">Issue #47839</a>
 */
public class UpdateSocketTimeoutOnConnectionCreationInterceptor extends SocketTimeoutInterceptor implements AgroalPoolInterceptor {
    ...
    private static final Logger logger = Logger.getLogger(UpdateSocketTimeoutOnConnectionCreationInterceptor.class);
