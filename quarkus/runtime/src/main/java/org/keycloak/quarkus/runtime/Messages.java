...
public final class Messages {
    ...
    public static String optimizedUsedForFirstStartup(String option) {
        return String.format("%s for first ever server start. Please don't use this for the first startup or use '%s %s' to build the server first.", option, Environment.getCommand(), Build.NAME);
    }
