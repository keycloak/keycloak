...
public class Picocli {
    ...
    public void validateConfig(List<String> cliArgs, AbstractCommand abstractCommand) {
        ...
        try {
            ...
            // - this will catch required values, and anything missing from the property names
            ...
            // last pass, look specifically at disabled
    ...
    private static void checkRuntimeSpiOptions(String key, IncludeOptions options, final List<String> ignoredRunTime) {
