...
public class BootstrapAdminUser extends AbstractNonServerCommand {
    ...
    protected void doBeforeRun() {
        ...
        if (usernameOptions != null) {
            ...
            username = IoUtils.readFromConsole("username", ApplianceBootstrap.DEFAULT_TEMP_ADMIN_USERNAME);
        }
        ...
        if (passwordEnv == null) {
            ...
            password = IoUtils.readFromConsole("password");
            String confirmPassword = IoUtils.readFromConsole("password again");
