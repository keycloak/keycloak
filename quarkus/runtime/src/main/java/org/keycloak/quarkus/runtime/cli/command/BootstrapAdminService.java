...
public class BootstrapAdminService extends AbstractNonServerCommand {
    ...
    protected void doBeforeRun() {
        ...
        if (clientIdOptions != null) {
            ...
            clientId = IoUtils.readFromConsole("client id", ApplianceBootstrap.DEFAULT_TEMP_ADMIN_SERVICE);
        }
        ...
        if (clientSecretEnv == null) {
            ...
            clientSecret = IoUtils.readFromConsole("client secret");
            String confirmClientSecret = IoUtils.readFromConsole("client secret again");
