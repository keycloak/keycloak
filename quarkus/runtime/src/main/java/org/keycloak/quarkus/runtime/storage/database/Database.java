...
public final class Database {
    ...
    private enum Vendor {
        ...
        MYSQL("mysql",
                ...
                "jdbc:mysql://${kc.db-url-host:localhost}/${kc.db-url-database:${quarkus.hibernate-orm.database.default-schema:keycloak}}${kc.db-url-properties:}",
        ...
        MARIADB("mariadb",
                ...
                "jdbc:mariadb://${kc.db-url-host:localhost}/${kc.db-url-database:${quarkus.hibernate-orm.database.default-schema:keycloak}}${kc.db-url-properties:}",
        ...
        POSTGRES("postgresql",
                ...
                "jdbc:postgresql://${kc.db-url-host:localhost}/${kc.db-url-database:${quarkus.hibernate-orm.database.default-schema:keycloak}}${kc.db-url-properties:}",
        ...
        MSSQL("mssql",
                ...
                "jdbc:sqlserver://${kc.db-url-host:localhost}:1433;databaseName=${kc.db-url-database:${quarkus.hibernate-orm.database.default-schema:keycloak}}${kc.db-url-properties:}",
        ...
        ORACLE("oracle",
                ...
                "jdbc:oracle:thin:@//${kc.db-url-host:localhost}:1521/${kc.db-url-database:${quarkus.hibernate-orm.database.default-schema:keycloak}}",
