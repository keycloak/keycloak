...
public class ConfigurationTest {
    ...
    public void testDatabaseDefaults() {
        ...
        assertEquals(replaceSeparators("jdbc:h2:file:" + System.getProperty("user.home") + File.separator + "data" + File.separator + "h2" + File.separator + "keycloakdb;;AUTO_SERVER=TRUE;NON_KEYWORDS=VALUE"), config.getConfigValue("quarkus.datasource.jdbc.url").getValue());
    ...
    public void testDatabaseProperties() {
        ...
        SmallRyeConfig config = createConfig();
        assertEquals(H2Dialect.class.getName(), config.getConfigValue("kc.db-dialect").getValue());
        assertEquals(replaceSeparators("jdbc:h2:file:test-dir" + File.separator + "data" + File.separator + "h2" + File.separator + "keycloakdb;;test=test;test1=test1;NON_KEYWORDS=VALUE"), config.getConfigValue("quarkus.datasource.jdbc.url").getValue());
    ...
    private String replaceSeparators(String snippet){
