...
public class IgnoredArtifactsTest {
    ...
    @Test
    public void tracingJdbc() {
        setSystemProperty(NS_KEYCLOAK_PREFIX + TracingOptions.TRACING_ENABLED.getKey(), "true",
                () -> assertIgnoredArtifacts(IgnoredArtifacts.TRACING_JDBC, TracingOptions.TRACING_JDBC_ENABLED));
    }
