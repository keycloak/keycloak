...
public class LoggingConfigurationTest extends AbstractConfigurationTest {
    ...
    public void logsExportPriority() {
        ConfigArgsConfigSource.setCliArgs("--features=opentelemetry-logs", "--log-export-enabled=true", "--log-export-endpoint=localhost:2000", "--log-export-protocol=http/protobuf", "--log-export-level=warn");
        initConfig();
        assertConfig(Map.of(
        ...
        ConfigArgsConfigSource.setCliArgs("--features=opentelemetry-logs", "--telemetry-endpoint=http://keycloak.org:1234", "--telemetry-protocol=grpc", "--log-export-enabled=true", "--log-export-endpoint=my-domain:2001", "--log-export-protocol=http/protobuf");
        initConfig();
        assertConfig(Map.of(
                "log-export-enabled", "true",
