...
public class OptionsDistTest {
    ...
    public void testServerDoesNotStartIfDisabledFileLogOption(CLIResult result) {
        ...
        result.assertError("--log, --log-console-output, --log-console-level, --log-console-format, --log-console-color, --log-console-async, --log-level, --log-level-<category>");
    }
    ...
    public void testServerDoesNotStartDevIfDisabledFileLogOption(CLIResult result) {
        result.assertError("Disabled option: '--log-file-output'. Available only when File log handler is activated");
        result.assertError("Possible solutions: --log, --log-console-output, --log-console-level, --log-console-format, --log-console-color, --log-console-async, --log-level, --log-level-<category>");
    }
    ...
    public void testServerStartDevIfEnabledFileLogOption(CLIResult result) {
        ...
        result.assertError("Possible solutions: --log, --log-file, --log-file-level, --log-file-format, --log-file-json-format, --log-file-output, --log-file-async, --log-level, --log-level-<category>");
    }
