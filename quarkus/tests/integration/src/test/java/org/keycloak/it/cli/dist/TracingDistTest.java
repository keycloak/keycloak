...
public class TracingDistTest {
    ...
    void differentServiceName(LaunchResult result) {
        ...
        cliResult.assertMessage("- tracing-service-name: Service name is not directly related to Tracing and you should use the OpenTelemetry option. Use otel-service-name.");
    ...
    void resourceAttributes(LaunchResult result) {
        ...
        assertTracingEnabled(cliResult);
        cliResult.assertMessage("- tracing-resource-attributes: Resource attributes are not directly related to Tracing and you should use the OpenTelemetry option which takes precedence. Use otel-resource-attributes.");
