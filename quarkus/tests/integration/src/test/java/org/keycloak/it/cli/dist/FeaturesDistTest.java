...
public class FeaturesDistTest {
    ...
    private static final String PREVIEW_FEATURES_EXPECTED_LOG = "Preview features enabled: admin-fine-grained-authz:v1, client-secret-rotation:v1, dpop:v1, multi-site:v1, oid4vc-vci:v1 recovery-codes:v1, scripts:v1, token-exchange:v1, update-email:v1";
