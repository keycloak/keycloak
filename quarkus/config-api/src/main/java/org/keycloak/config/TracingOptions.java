...
public class TracingOptions {
    ...
    public static final Option<String> TRACING_SERVICE_NAME = new OptionBuilder<>("tracing-service-name", String.class)
            .category(OptionCategory.TRACING)
            .deprecated()
            .deprecatedMetadata(DeprecatedMetadata.deprecateOption("Service name is not directly related to Tracing and you should use the Telemetry option option which takes precedence.", TelemetryOptions.TELEMETRY_SERVICE_NAME.getKey()))
