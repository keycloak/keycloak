...
public class HttpOptions {
    ...
    public static final Option<String> HTTP_COOKIE_PREFIX = new OptionBuilder<>("http-cookie-prefix", String.class)
            .category(OptionCategory.HTTP)
            .description("A prefix to prepend to all cookie names generated by Keycloak. " +
                    "Useful for blue-green deployments or running multiple Keycloak instances on the same domain to prevent session conflicts. " +
