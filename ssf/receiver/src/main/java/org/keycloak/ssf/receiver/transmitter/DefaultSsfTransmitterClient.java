...
public class DefaultSsfTransmitterClient implements SsfTransmitterClient {
    ...
    @Override
    public TransmitterMetadata loadTransmitterMetadata(SsfReceiver receiver) {

        TransmitterMetadata metadata = loadFromCache(receiver);
    ...
    @Override
    public TransmitterMetadata fetchTransmitterMetadata(SsfReceiver receiver) {
    ...
    protected void storeToCache(SsfReceiver receiver, TransmitterMetadata metadata) {
    ...
    protected TransmitterMetadata loadFromCache(SsfReceiver receiver) {
        ...
        if (cachedTransmitterMetadata != null) {
            ...
            try {
                RealmModel realm = session.getContext().getRealm();
                TransmitterMetadata metadata = JsonSerialization.readValue(jsonData, TransmitterMetadata.class);
