...
import org.keycloak.ssf.receiver.registration.SsfReceiverRegistrationProviderConfig.TransmitterAuthMethod;
...
public class DefaultSsfVerificationClient implements SsfVerificationClient {
    ...
    @Override
    public void requestVerification(SsfReceiver receiver, TransmitterMetadata metadata, String state) {
