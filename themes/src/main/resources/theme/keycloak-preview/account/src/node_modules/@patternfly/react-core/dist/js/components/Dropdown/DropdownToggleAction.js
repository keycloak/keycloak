...
function (_React$Component) {
  ...
  function DropdownToggleAction() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DropdownToggleAction).apply(this, arguments));
  }
  ...
  _createClass(DropdownToggleAction, [{
    ...
    value: function render() {
      ...
      return React.createElement("button", _extends({
        id: id,
        className: (0, _reactStyles.css)(_dropdown["default"].dropdownToggleButton, className),
        onClick: onClick
      }, isDisabled && {
        disabled: true,
        'aria-disabled': true
