(function (global, factory) {
  ...
  exports.ModalBoxDescription = undefined;
  ...
  const ModalBoxDescription = exports.ModalBoxDescription = _ref => {
    let {
      children = null,
      className = '',
      id = ''
    ...
    return React.createElement("div", _extends({}, props, {
      id: id,
      className: (0, _reactStyles.css)(_modalBox2.default.modalBoxDescription, className)
    }), children);
  };
