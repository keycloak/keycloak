(function (global, factory) {
  ...
  exports.OverflowMenuGroup = undefined;
  ...
  const OverflowMenuGroup = exports.OverflowMenuGroup = ({
    className,
    children,
    isPersistent = false,
    groupType
  }) => React.createElement(_OverflowMenuContext.OverflowMenuContext.Consumer, null, value => (isPersistent || !value.isBelowBreakpoint) && React.createElement("div", {
    className: (0, _reactStyles.css)(_overflowMenu2.default.overflowMenuGroup, groupType === 'button' && _overflowMenu2.default.modifiers.buttonGroup, groupType === 'icon' && _overflowMenu2.default.modifiers.iconButtonGroup, className)
  }, children));
  ...
  OverflowMenuGroup.propTypes = {
    ...
    groupType: _propTypes2.default.oneOf(['button', 'icon'])
  };
});
