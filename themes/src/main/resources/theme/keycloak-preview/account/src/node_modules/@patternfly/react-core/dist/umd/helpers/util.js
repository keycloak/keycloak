(function (global, factory) {
  ...
  exports.canUseDOM = exports.formatBreakpointMods = undefined;
  ...
  const formatBreakpointMods = exports.formatBreakpointMods = (breakpointMods, styles) => breakpointMods.reduce((acc, curr) => `${acc}${acc && ' '}${(0, _reactStyles.getModifier)(styles, `${curr.modifier}${curr.breakpoint ? `-on-${curr.breakpoint}` : ''}`)}`, '');
