...
var SimpleListGroup = function SimpleListGroup(_ref) {
  ...
  return React.createElement("section", _extends({
    className: (0, _reactStyles.css)(_simpleList["default"].simpleListSection)
  }, props), React.createElement("h2", {
    id: id,
    className: (0, _reactStyles.css)(_simpleList["default"].simpleListTitle, titleClassName),
    "aria-hidden": "true"
