(function (global, factory) {
  ...
  const Flex = exports.Flex = _ref => {
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_flex2.default.flex, breakpointMods.length > 0 && (0, _util.formatBreakpointMods)(breakpointMods, _flex2.default), className)
    }, props), children);
  };
