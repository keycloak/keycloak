...
var SimpleListContext = React.createContext({});
...
function (_React$Component) {
  ...
  function SimpleList() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SimpleList)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "state", {
      currentRef: null
    });

    _defineProperty(_assertThisInitialized(_this), "handleCurrentUpdate", function (newCurrentRef, itemProps) {
      _this.setState({
  ...
  _createClass(SimpleList, [{
    ...
    value: function render() {
      ...
      return React.createElement(SimpleListContext.Provider, {
        ...
        className: (0, _reactStyles.css)(_simpleList["default"].simpleList, className)
      }, props, isGrouped && {
        role: 'list'
