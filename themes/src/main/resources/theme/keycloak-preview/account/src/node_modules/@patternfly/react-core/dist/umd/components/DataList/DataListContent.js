(function (global, factory) {
  ...
  exports.DataListContent = undefined;
  ...
  const DataListContent = exports.DataListContent = _ref => {
    let {
      className = '',
      children = null,
      id = '',
    ...
    return React.createElement("section", _extends({
      id: id,
      className: (0, _reactStyles.css)(_dataList2.default.dataListExpandableContent, className),
      hidden: isHidden,
      "aria-label": ariaLabel
    }, props), React.createElement("div", {
      className: (0, _reactStyles.css)(_dataList2.default.dataListExpandableContentBody, noPadding && _dataList2.default.modifiers.noPadding)
    }, children));
  };
