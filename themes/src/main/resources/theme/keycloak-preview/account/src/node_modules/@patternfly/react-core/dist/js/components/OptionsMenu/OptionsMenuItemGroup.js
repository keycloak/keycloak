...
var OptionsMenuItemGroup = function OptionsMenuItemGroup(_ref) {
  var _ref$className = _ref.className,
      ...
      groupTitle = _ref$groupTitle === void 0 ? '' : _ref$groupTitle,
  ...
  return React.createElement("section", _extends({}, props, {
    className: (0, _reactStyles.css)(_optionsMenu["default"].optionsMenuGroup)
  }), groupTitle && React.createElement("h1", {
    className: (0, _reactStyles.css)(_optionsMenu["default"].optionsMenuGroupTitle)
  }, groupTitle), React.createElement("ul", {
    className: className,
    "aria-label": ariaLabel
  }, children, hasSeparator && React.createElement("li", {
    className: (0, _reactStyles.css)(_optionsMenu["default"].optionsMenuSeparator),
    role: "separator"
  })));
};
...
OptionsMenuItemGroup.propTypes = {
  ...
  groupTitle: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].node]),
