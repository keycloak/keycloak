...
var AlertActionCloseButton = function AlertActionCloseButton(_ref) {
  ...
  return React.createElement(_AlertContext.AlertContext.Consumer, null, function (_ref2) {
    var title = _ref2.title,
        alertVariantLabel = _ref2.variantLabel;
    return React.createElement(_Button.Button, _extends({
      variant: _Button.ButtonVariant.plain,
      onClick: onClose,
      "aria-label": ariaLabel === '' ? "Close ".concat(variantLabel || alertVariantLabel, " alert: ").concat(title) : ariaLabel
