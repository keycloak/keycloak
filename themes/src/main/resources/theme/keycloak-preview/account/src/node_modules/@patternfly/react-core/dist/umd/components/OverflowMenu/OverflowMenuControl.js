(function (global, factory) {
  ...
  exports.OverflowMenuControl = undefined;
  ...
  const OverflowMenuControl = exports.OverflowMenuControl = ({
    className,
    children,
    hasAdditionalOptions
  }) => React.createElement(_OverflowMenuContext.OverflowMenuContext.Consumer, null, value => (value.isBelowBreakpoint || hasAdditionalOptions) && React.createElement("div", {
    className: (0, _reactStyles.css)(_overflowMenu2.default.overflowMenuControl, className)
  }, " ", children, " "));

  OverflowMenuControl.propTypes = {
    children: _propTypes2.default.any,
    className: _propTypes2.default.string,
    hasAdditionalOptions: _propTypes2.default.bool
  };
});
