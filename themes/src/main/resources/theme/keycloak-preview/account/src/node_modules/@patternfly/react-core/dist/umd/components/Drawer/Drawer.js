(function (global, factory) {
  ...
  exports.Drawer = exports.DrawerContext = undefined;
  ...
  const DrawerContext = exports.DrawerContext = React.createContext({
    isExpanded: false
  });
  ...
  const Drawer = exports.Drawer = _ref => {
    ...
    return React.createElement(DrawerContext.Provider, {
      ...
      className: (0, _reactStyles.css)(_drawer2.default.drawer, isExpanded && _drawer2.default.modifiers.expanded, isInline && _drawer2.default.modifiers.inline, isStatic && _drawer2.default.modifiers.static, position === 'left' && _drawer2.default.modifiers.panelLeft, className)
    }, props), children));
  };
