...
const MultipleFileUploadTitleTextSeparator = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(multiple_file_upload_1.default.multipleFileUploadTitleTextSeparator, className) }, props), children));
};
