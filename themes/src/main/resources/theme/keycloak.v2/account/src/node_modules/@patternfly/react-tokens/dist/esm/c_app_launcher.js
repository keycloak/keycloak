export const c_app_launcher = {
  ".pf-c-app-launcher": {
    ...
    "c_app_launcher__menu_item_m_action_disabled_Color": {
      "name": "--pf-c-app-launcher__menu-item--m-action--disabled--Color",
      "value": "#d2d2d2",
      "values": [
        "--pf-global--disabled-color--200",
        "$pf-global--disabled-color--200",
    ...
    "c_app_launcher__menu_item_m_favorite__menu_item_m_action_hover_Color": {
      "name": "--pf-c-app-launcher__menu-item--m-favorite__menu-item--m-action--hover--Color",
      "value": "#c58c00",
      "values": [
  ...
  ".pf-c-app-launcher__menu-wrapper.pf-m-favorite": {
    ...
    "c_app_launcher__menu_item_m_action_hover_Color": {
      ...
      "value": "#c58c00",
      "values": [
        "--pf-c-app-launcher__menu-item--m-favorite__menu-item--m-action--hover--Color",
        "--pf-global--palette--gold-500",
        "$pf-color-gold-500",
        "#c58c00"
      ]
  ...
  ".pf-c-app-launcher__menu-item:disabled": {
    ...
    "c_app_launcher__menu_item_m_action_Color": {
      ...
      "value": "#d2d2d2",
      "values": [
        "--pf-c-app-launcher__menu-item--m-action--disabled--Color",
        "--pf-global--disabled-color--200",
        "$pf-global--disabled-color--200",
        "$pf-color-black-300",
        "#d2d2d2"
