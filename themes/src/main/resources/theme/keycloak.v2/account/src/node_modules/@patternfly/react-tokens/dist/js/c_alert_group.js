...
exports.c_alert_group = {
  ".pf-c-alert-group": {
    ...
    "c_alert_group__overflow_button_BorderWidth": {
      "name": "--pf-c-alert-group__overflow-button--BorderWidth",
      "value": "0"
    },
    "c_alert_group__overflow_button_PaddingTop": {
      "name": "--pf-c-alert-group__overflow-button--PaddingTop",
      "value": "1.5rem",
      "values": [
        "--pf-global--spacer--lg",
        "$pf-global--spacer--lg",
    ...
    "c_alert_group__overflow_button_PaddingRight": {
      "name": "--pf-c-alert-group__overflow-button--PaddingRight",
      "value": "1rem",
      "values": [
        "--pf-global--spacer--md",
        "$pf-global--spacer--md",
    ...
    "c_alert_group__overflow_button_PaddingLeft": {
      "name": "--pf-c-alert-group__overflow-button--PaddingLeft",
      "value": "1rem",
      "values": [
        "--pf-global--spacer--md",
        "$pf-global--spacer--md",
    ...
    "c_alert_group__overflow_button_BoxShadow": {
      "name": "--pf-c-alert-group__overflow-button--BoxShadow",
    ...
    "c_alert_group__overflow_button_hover_Color": {
      "name": "--pf-c-alert-group__overflow-button--hover--Color",
      "value": "#004080",
      "values": [
    ...
    "c_alert_group__overflow_button_hover_BoxShadow": {
      ...
      "values": [
        "--pf-global--BoxShadow--lg, --pf-global--BoxShadow--lg-bottom",
        "$pf-global--BoxShadow--lg, $pf-global--BoxShadow--lg-bottom",
        "0 pf-size-prem(8px) pf-size-prem(16px) 0 rgba($pf-color-black-1000, .16), 0 0 pf-size-prem(6px) 0 rgba($pf-color-black-1000, .08), 0 pf-size-prem(12px) pf-size-prem(12px) pf-size-prem(-8px) rgba($pf-color-black-1000, .18)",
    ...
    "c_alert_group__overflow_button_focus_Color": {
      "name": "--pf-c-alert-group__overflow-button--focus--Color",
      "value": "#004080",
      "values": [
        "--pf-global--link--Color--hover",
        "$pf-global--link--Color--hover",
  ...
  ".pf-c-alert-group__overflow-button:hover": {
    "c_alert_group__overflow_button_Color": {
      ...
      "value": "#004080",
      "values": [
        "--pf-c-alert-group__overflow-button--hover--Color",
        "--pf-global--link--Color--hover",
        "$pf-global--link--Color--hover",
        "$pf-global--primary-color--200",
        "$pf-color-blue-500",
  ...
  ".pf-c-alert-group__overflow-button:focus": {
    "c_alert_group__overflow_button_Color": {
      ...
      "value": "#004080",
      "values": [
        "--pf-c-alert-group__overflow-button--focus--Color",
        "--pf-global--link--Color--hover",
        "$pf-global--link--Color--hover",
        "$pf-global--primary-color--200",
        "$pf-color-blue-500",
  ...
  ".pf-c-alert-group__overflow-button:active": {
    "c_alert_group__overflow_button_Color": {
      ...
      "value": "#004080",
      "values": [
        "--pf-c-alert-group__overflow-button--active--Color",
        "--pf-global--link--Color--hover",
        "$pf-global--link--Color--hover",
        "$pf-global--primary-color--200",
        "$pf-color-blue-500",
