...
exports.TextInputGroupUtilities = void 0;
...
const TextInputGroupUtilities = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(text_input_group_1.default.textInputGroupUtilities, className) }, props), children));
};
exports.TextInputGroupUtilities = TextInputGroupUtilities;
exports.TextInputGroupUtilities.displayName = 'TextInputGroupUtilities';
