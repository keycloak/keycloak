export const c_form_control_m_icon_m_warning_BackgroundUrl: {
  ...
  "var": "var(--pf-c-form-control--m-icon--m-warning--BackgroundUrl)"
};
export default c_form_control_m_icon_m_warning_BackgroundUrl;