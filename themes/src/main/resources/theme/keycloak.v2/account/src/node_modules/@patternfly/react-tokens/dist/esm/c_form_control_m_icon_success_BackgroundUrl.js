export const c_form_control_m_icon_success_BackgroundUrl = {
  ...
  "var": "var(--pf-c-form-control--m-icon--success--BackgroundUrl)"
};
export default c_form_control_m_icon_success_BackgroundUrl;