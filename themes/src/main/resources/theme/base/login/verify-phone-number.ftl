...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('phoneNumber'); section>
    ...
    <#elseif section="form">
        <form id="kc-verify-phone-form" class="${properties.kcFormClass!}" onsubmit="login.disabled = true; return true;" action="${url.loginAction}"
            method="post">
            ...
            <div class="${properties.kcFormGroupClass!}">
                <div id="kc-form-options" class="${properties.kcFormOptionsClass!}">
                    <div class="${properties.kcFormOptionsWrapperClass!}">
                        ${msg("verifyPhoneNumberInstruction")}
                    </div>
                </div>
