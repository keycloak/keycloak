   ...
   <#elseif section = "form">
    ...
    <form action="${url.loginAction}" class="form-vertical" method="post">
      ...
      <div id="kc-form-buttons">
            ...
            <button class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonLargeClass!}" style="margin-left: calc(100% - 220px)" type="submit" name="cancel-aia" value="true" />${msg("doCancel")}</button>
            </#if>
       </div>
    </form>
   </#if>
