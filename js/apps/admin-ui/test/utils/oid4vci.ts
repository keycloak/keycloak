...
export const OID4VC_MDOC_SERVER_FEATURE = "OID4VC_MDOC";
...
export const OID4VC_MDOC_UNAVAILABLE_MESSAGE =
  "OID4VC mdoc format is unavailable. Start Keycloak with oid4vc-mdoc feature enabled.";
...
export async function skipIfOID4VCIMdocFeatureDisabled() {
  ...
  // eslint-disable-next-line playwright/no-skipped-test -- This gate documents when the server cannot run OID4VCI mdoc tests.
  test.skip(!isOID4VCIMdocFeatureEnabled, OID4VC_MDOC_UNAVAILABLE_MESSAGE);
}
