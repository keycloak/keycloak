...
const KebabDropdown = () => {
  ...
  return (
    ...
    >
      <DropdownList>{kebabDropdownItems(isManager)}</DropdownList>
    </Dropdown>
  );
};
...
const UserDropdown = () => {
  ...
  return (
    ...
    >
      <DropdownList>{userDropdownItems(isManager)}</DropdownList>
    </Dropdown>
  );
};
