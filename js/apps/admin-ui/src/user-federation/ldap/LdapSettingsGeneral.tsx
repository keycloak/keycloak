  ...
  const setVendorDefaultValues = () => {
    switch (form.getValues("config.vendor[0]")) {
      case "ad":
        ...
        form.setValue("config.kerberosPrincipalLDAPAttribute[0]", "userPrincipalName");
        form.setValue(
      ...
      case "rhds":
        ...
        form.setValue("config.kerberosPrincipalLDAPAttribute[0]", "krbPrincipalName");
        form.setValue(
          "config.userObjectClasses[0]",
      ...
      case "other":
        ...
        form.setValue("config.kerberosPrincipalLDAPAttribute[0]", "krb5PrincipalName");
        form.setValue(
          "config.userObjectClasses[0]",
          "inetOrgPerson, organizationalPerson",
        );
