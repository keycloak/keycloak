import { FormErrorText, HelpItem } from "@keycloak/keycloak-ui-shared-pf6";
import { Label, FormGroup, Split, SplitItem } from "@patternfly/react-core";
      ...
      <Controller
        ...
        render={({ field }) => (
          <Split>
            ...
            {field.value !== "" && (
              <SplitItem>
                <Label textMaxWidth="500px" onClick={() => field.onChange("")}>
                  <ServiceRole
