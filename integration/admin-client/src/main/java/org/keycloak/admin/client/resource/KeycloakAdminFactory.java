...
public class KeycloakAdminFactory {
    ...
    public static KeycloakRealm getRealm(Config config, TokenManager tokenManager, String realmName){
        ...
        KeycloakAdminRoot adminRoot = target.proxy(KeycloakAdminRoot.class);
