...
public class KcAdmV2Cmd extends AbstractTargetAuthOptionsCmd {
    ...
    protected void configureCommandLine(CommandLine cli) {
        ...
        // HINT: we only have the connection options on the root command, if that ever changes, we need to update
        // how org.keycloak.client.admin.cli.v2.KcAdmV2CommandBuilder.connectionOptions is computed
