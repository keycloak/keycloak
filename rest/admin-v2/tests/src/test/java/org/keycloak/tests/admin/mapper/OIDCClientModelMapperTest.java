...
public class OIDCClientModelMapperTest {
    ...
    public void fromModel_mapsBasicFields(KeycloakSession session) {
        ...
        try {
            ...
            OIDCClientModelSchema schema = OIDCClientModelSchema.INSTANCE;
            ...
            assertThat(oidcRep.isFieldExplicitlySet("type"), is(false));
            assertThat(oidcRep.isFieldExplicitlySet("loginFlows"), is(false));

            oidcRep.setType(null);
            assertThat(oidcRep.isFieldExplicitlySet("type"), is(true));
        } finally {
    ...
    public void fromModel_mapsLoginFlows(KeycloakSession session) {
        ...
        try {
            ...
            OIDCClientModelSchema schema = OIDCClientModelSchema.INSTANCE;
            OIDCClientRepresentation rep = (OIDCClientRepresentation) schema.fromModel(clientModel);
