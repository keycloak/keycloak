...
@Schema
public class BaseOIDCClientRepresentation<T extends BaseOIDCClientRepresentation.Auth> extends BaseClientRepresentation {
    ...
    public BaseOIDCClientRepresentation() {}

    public BaseOIDCClientRepresentation(String clientId) {
    ...
    @Override
    public boolean equals(Object o) {
        if (!(o instanceof BaseOIDCClientRepresentation that)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
