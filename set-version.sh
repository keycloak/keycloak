...
echo "$(jq '. += {"version": "'$NEW_NPM_VERSION'"}' js/libs/ui-shared-pf6/package.json)" > js/libs/ui-shared-pf6/package.json
echo "$(jq '. += {"version": "'$NEW_NPM_VERSION'"}' js/apps/account-ui-pf6/package.json)" > js/apps/account-ui-pf6/package.json
echo "$(jq '. += {"version": "'$NEW_NPM_VERSION'"}' js/apps/admin-ui-pf6/package.json)" > js/apps/admin-ui-pf6/package.json
