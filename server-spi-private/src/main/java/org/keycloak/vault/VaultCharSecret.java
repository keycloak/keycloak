...
public interface VaultCharSecret extends AutoCloseable {
    ...
    /**
     * Returns the secret enclosed in a {@code CharBuffer}.
     * @return If the secret was successfully resolved by vault, returns an {@link Optional} containing the value returned
     *         by the vault as a {@code CharBuffer} (a valid value can be {@code null}), or an empty {@link Optional}
     */
    Optional<CharBuffer> getCharSecret();
