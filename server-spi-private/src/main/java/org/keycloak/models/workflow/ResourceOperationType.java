...
public enum ResourceOperationType {
    ...
    USER_ADDED(ResourceType.USERS, List.of(OperationType.CREATE, EventType.REGISTER)),
    USER_LOGGED_IN(ResourceType.USERS, List.of(EventType.LOGIN), userLoginPredicate()),
    ...
    USER_ROLE_ADDED(ResourceType.USERS, List.of(RoleGrantedEvent.class), roleMembershipPredicate()),
