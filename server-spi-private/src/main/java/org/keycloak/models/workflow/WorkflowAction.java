...
public class WorkflowAction implements Comparable<WorkflowAction> {
    ...
    private List<WorkflowAction> actions = List.of();

    public WorkflowAction() {
        // reflection
    }

    public WorkflowAction(String providerId) {
        this.providerId = providerId;
    }

    public WorkflowAction(String providerId, MultivaluedHashMap<String, String> config, List<WorkflowAction> actions) {
        this.providerId = providerId;
        this.config = config;
        this.actions = actions;
    }

    public WorkflowAction(ComponentModel model) {
        this.id = model.getId();
    ...
    public WorkflowAction setConfig(String key, String value) {
        if (config == null) {
    ...
    @Override
    public int compareTo(WorkflowAction other) {
