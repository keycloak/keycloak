...
public interface ActionTokenStoreProvider extends Provider {
    ...
    void addActionToken(ActionTokenKeyModel actionToken, ActionTokenValueModel actionTokenValue);
     ...
     */
    ActionTokenValueModel get(ActionTokenKeyModel key, UUID nonce);
     ...
     * @return {@code null} if no token is found for given key and nonce, value otherwise
     */
    ActionTokenValueModel removeActionToken(ActionTokenKeyModel key, UUID nonce);
