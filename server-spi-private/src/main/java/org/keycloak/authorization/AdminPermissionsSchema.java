...
public class AdminPermissionsSchema extends AuthorizationSchema {
    ...
    public static final ResourceType CLIENTS = new ResourceType(CLIENTS_RESOURCE_TYPE, Set.of(CONFIGURE, MANAGE, MAP_ROLES, MAP_ROLES_CLIENT_SCOPE, MAP_ROLES_COMPOSITE, TOKEN_EXCHANGE, VIEW));
    ...
    public Resource getOrCreateResource(KeycloakSession session, ResourceServer resourceServer, String type, String id) {
        ...
        } else if (CLIENTS.getType().equals(type)) {
