...
:project_versionMvn: 15.0.2.redhat-00001
:project_versionNpm: 15.0.2.redhat-00001
...
:project_templates_base_url: https://raw.githubusercontent.com/jboss-container-images/redhat-sso-7-openshift-image/sso75-dev/templates
...
:openshift_openj9_name: Red Hat Single Sign-On for OpenShift
:openshift_openj9_link: {project_doc_base_url}/red_hat_single_sign-on_for_openshift/
...
:openshift_openj9_project_templates_version: sso75-openj9
