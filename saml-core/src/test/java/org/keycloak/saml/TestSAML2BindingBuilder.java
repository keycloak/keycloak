...
/**
 * SAML2BindingBuilder for testing purposes.
 *
...
public class TestSAML2BindingBuilder extends BaseSAML2BindingBuilder<TestSAML2BindingBuilder> {
    ...
    public static class RedirectBindingBuilder extends BaseRedirectBindingBuilder {
        ...
        public String request(String redirectUri) throws ProcessingException, ConfigurationException, IOException {
            return response(redirectUri, true);
        }
