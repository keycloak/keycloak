...
public class SAML2ArtifactResolveResponseBuilder implements SamlProtocolExtensionsAwareBuilder<SAML2ArtifactResolveResponseBuilder> {
    protected String artifact;
    protected String destination;
    protected NameIDType issuer;
    protected final List<NodeGenerator> extensions = new LinkedList<>();

    public SAML2ArtifactResolveResponseBuilder artifact(String artifact) {
        this.artifact = artifact;
        return this;
    }

    public SAML2ArtifactResolveResponseBuilder destination(String destination) {
        this.destination = destination;
        return this;
    }

    public SAML2ArtifactResolveResponseBuilder issuer(NameIDType issuer) {
        this.issuer = issuer;
        return this;
    }

    public SAML2ArtifactResolveResponseBuilder issuer(String issuer) {
        return issuer(SAML2NameIDBuilder.value(issuer).build());
    }

    @Override
    public SAML2ArtifactResolveResponseBuilder addExtension(NodeGenerator extension) {
