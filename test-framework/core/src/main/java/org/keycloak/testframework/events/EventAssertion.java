...
public class EventAssertion {
    ...
    /**
     * Assert the event has a time set
     * @return
     */
    public EventAssertion hasTime() {
        Assertions.assertTrue(event.getTime() > 0);
        return this;
    }

    /**
     * Assert the realmId for the event
     *
     * @param realmId the expected realmId
     * @return
     */
    public EventAssertion realmId(String realmId) {
        Assertions.assertEquals(realmId, event.getRealmId());
        return this;
    }
