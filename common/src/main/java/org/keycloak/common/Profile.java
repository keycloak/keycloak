...
public class Profile {
    ...
    public enum Feature {
        ...
        PASSKEYS("Quantum Pass", Type.DEFAULT, Feature.WEB_AUTHN),
        PASSKEYS_CONDITIONAL_UI_AUTHENTICATOR("Quantum Pass conditional UI authenticator", Type.DEPRECATED, FeatureUpdatePolicy.ROLLING_NO_UPGRADE, Feature.PASSKEYS),
