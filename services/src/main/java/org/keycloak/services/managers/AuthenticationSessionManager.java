...
public class AuthenticationSessionManager {
     ...
     * AUT_SESSION cookie but we fall back to the identity cookie.
     *
     * Note : the AUTh_SESSION cookie is a session cookie that can disappear when the browser is closed
     *
     * @param realm
     * @return
     */
