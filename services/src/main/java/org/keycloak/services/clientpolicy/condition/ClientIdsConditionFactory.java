...
import static org.keycloak.services.clientpolicy.condition.AbstractClientPolicyConditionProviderFactory.addCommonConfigProperties;
...
public class ClientIdsConditionFactory implements ClientPolicyConditionProviderFactory {
  ...
  @Override public ClientPolicyConditionProvider<ClientIdsCondition.Configuration> create(KeycloakSession session) {
