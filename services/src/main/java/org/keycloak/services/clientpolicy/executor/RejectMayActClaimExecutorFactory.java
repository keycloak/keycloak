...
public class RejectMayActClaimExecutorFactory implements ClientPolicyExecutorProviderFactory, EnvironmentDependentProviderFactory {
    ...
    public String getHelpText() {
        return """
               Checks the 'may_act' claim in the token response generated during token exchange and rejects tokens
               with missing or invalid 'may_act' values based on issuer, subject, permission, or consent validation
               """;
    }
