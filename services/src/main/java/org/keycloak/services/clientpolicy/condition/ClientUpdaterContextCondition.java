...
public class ClientUpdaterContextCondition extends AbstractClientPolicyConditionProvider<ClientUpdaterContextCondition.Configuration> {
    ...
    public ClientPolicyVote applyPolicy(ClientPolicyContext context) throws ClientPolicyException {
        ...
        case REGISTER_SCOPE_MAPPING:
        case UNREGISTER_SCOPE_MAPPING:
            ClientScopeMappingContext scopeMappingContext = (ClientScopeMappingContext) context;
            if (isAuthMethodMatched(scopeMappingContext.getToken(),
                    scopeMappingContext.getAuthenticatedUser() != null || scopeMappingContext.getAuthenticatedClient() != null)) {
