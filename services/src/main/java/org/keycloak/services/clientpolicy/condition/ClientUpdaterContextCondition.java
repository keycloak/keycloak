...
public class ClientUpdaterContextCondition extends AbstractClientPolicyConditionProvider<ClientUpdaterContextCondition.Configuration> {
    ...
    public ClientPolicyVote applyPolicy(ClientPolicyContext context) throws ClientPolicyException {
        ...
        case UPDATE_CLIENT_CERTIFICATE:
            ClientCertificateContext certificateContext = (ClientCertificateContext) context;
            if (isAuthMethodMatched(certificateContext.getToken(),
                    certificateContext.getAuthenticatedUser() != null || certificateContext.getAuthenticatedClient() != null)) {
