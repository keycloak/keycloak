...
public class AccountService extends AbstractSecuredLocalService {
    ...
    private static final KeycloakLogger logger = Logger.getMessageLogger(KeycloakLogger.class, AccountService.class.getName());
