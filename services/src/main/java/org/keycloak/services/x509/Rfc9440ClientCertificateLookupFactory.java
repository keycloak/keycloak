...
public class Rfc9440ClientCertificateLookupFactory implements X509ClientCertificateLookupFactory {
    ...
    public void init(Config.Scope config) {
        if (config != null) {
            ...
            sslClientCertHttpHeader = HTTP_HEADER_CLIENT_CERT_DEFAULT;
            sslChainHttpHeader = HTTP_HEADER_CERT_CHAIN_DEFAULT;
            certificateChainLength = HTTP_HEADER_CERT_CHAIN_LENGTH_DEFAULT;
        }
