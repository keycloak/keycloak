 ...
 */
public class EntraOIDCIdentityProviderConfig extends OIDCIdentityProviderConfig {


    public EntraOIDCIdentityProviderConfig(IdentityProviderModel identityProviderModel) {
        super(identityProviderModel);
    }

    public EntraOIDCIdentityProviderConfig() {
        super();
    }
