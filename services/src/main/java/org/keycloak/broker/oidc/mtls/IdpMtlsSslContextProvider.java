...
public final class IdpMtlsSslContextProvider {
    ...
    public static KeyManager[] buildKeyManagers(KeyWrapper key) throws Exception {
        ...
        if (chain != null && !chain.isEmpty()) {
            ...
            // Without an explicit check the certs array would hold a single null entry and
            // KeyStore#setKeyEntry would fail with an opaque exception. This is a public utility, so fail
            // loudly with a clear message about the missing certificate material instead.
