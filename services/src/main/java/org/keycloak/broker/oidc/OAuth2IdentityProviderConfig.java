...
public class OAuth2IdentityProviderConfig extends IdentityProviderModel {
    ...
    public void validate(KeycloakSession session, RealmModel realm) {
        ...
        // provider's User Info/claim checks in OAuth2IdentityProviderFactory and Google's issuer check).
        // The base validate(session, realm) delegates to validate(realm); overriding this overload must
