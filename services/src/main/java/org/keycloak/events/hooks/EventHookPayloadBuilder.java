...
final class EventHookPayloadBuilder {

    private EventHookPayloadBuilder() {
    }

    static Map<String, Object> buildUserEventPayload(Event event) {
    ...
    static Map<String, Object> buildAdminEventPayload(AdminEvent event, boolean includeRepresentation) {
        Map<String, Object> payload = new LinkedHashMap<>();
