...
public class JWTClientAuthenticator extends AbstractClientAuthenticator {
    ...
    protected static KeycloakLogger logger = Logger.getMessageLogger(KeycloakLogger.class, JWTClientAuthenticator.class.getName());
    ...
    public void authenticateClient(ClientAuthenticationFlowContext context) {
        ...
        try {
            ...
            logger.CLIENT.errorValidatingAssertion(e);
