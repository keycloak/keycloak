 ...
 * @version $Revision: 1 $
 */
public class ValidateAesPhone extends AbstractDirectGrantAuthenticator {

    public static final String PROVIDER_ID = "direct-grant-validate-aes-phone";
    ...
    public String getHelpText() {
        return "Validates the phone supplied as a 'phone' form parameter in direct grant request";
    }
