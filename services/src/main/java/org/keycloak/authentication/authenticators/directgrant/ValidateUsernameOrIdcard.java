 ...
 * @version $Revision: 1 $
 */
public class ValidateUsernameOrIdcard extends AbstractDirectGrantAuthenticator {

    public static final String PROVIDER_ID = "direct-grant-validate-username-idcard";
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        UserModel user = null;
        try {
            if (IdcardUtil.validateCard(username)) {
    ...
    public String getDisplayType() {
        return "Username Or Idcard Validation";
    }
    ...
    public String getHelpText() {
        return "Validates the username or idcard supplied as a 'username' form parameter in direct grant request";
    }
