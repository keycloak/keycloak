 ...
 * @version $Revision: 1 $
 */
public class ValidateIdcardFirstName extends AbstractDirectGrantAuthenticator {

    public static final String PROVIDER_ID = "direct-grant-validate-idcard-firstname";
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        UserModel user = null;
        try {
            user = KeycloakModels.findUserByNameAndIdcard(context.getSession(), context.getRealm(), username);
    ...
    public String getDisplayType() {
        return "Idcard Firstname Validation";
    }
