 ...
 * @version $Revision: 1 $
 */
public class ValidateAesIdcard extends AbstractDirectGrantAuthenticator {

    public static final String PROVIDER_ID = "direct-grant-validate-aes-idcard";
