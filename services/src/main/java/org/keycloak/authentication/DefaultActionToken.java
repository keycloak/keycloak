...
public class DefaultActionToken extends DefaultActionTokenKey implements ActionTokenValueModel {
     ...
     * @param expirationInSecs Expiration time in seconds in timezone of Keycloak.
     * @param actionVerificationNonce
     */
    protected DefaultActionToken(String userId, String actionId, int expirationInSecs, UUID actionVerificationNonce) {
        super(userId, actionId);
        this.actionVerificationNonce = actionVerificationNonce == null ? UUID.randomUUID() : actionVerificationNonce;
        expiration = expirationInSecs;
    }
    ...
    public static ActionTokenKeyModel key(String userId, String actionId) {
        return new DefaultActionTokenKey(userId, actionId);
    }
