...
public class OID4VCIssuerEndpoint {
    ...
    public Response createCredentialOffer(
        ...
        // Bind pre-authorized code offers to the authenticated client to prevent redemption from a different client session.
        // Authorization Code Grant offers are intentionally not client-bound.
