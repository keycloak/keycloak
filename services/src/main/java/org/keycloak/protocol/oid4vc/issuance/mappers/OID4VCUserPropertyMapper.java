 ...
 */
public class OID4VCUserPropertyMapper extends OID4VCMapper {
    ...
    static {
        ...
        userAttributeConfig.setHelpText("The user property to be added to the credential subject.");
    ...
    public String getDisplayType() {
        return "User Property Mapper";
    }

    @Override
    public String getHelpText() {
        return "Maps user properties to credential claims.";
    }

    @Override
    public ProtocolMapper create(KeycloakSession session) {
        return new OID4VCUserPropertyMapper();
    }
