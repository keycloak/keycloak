...
public class AuthorizationRequestBuilder {
    ...
    public static AuthorizationRequestBuilder fromHttpParameters(Map<String, String> params) {
        try {
            ...
            if (params.containsKey("client_metadata")) {
                builder.clientMetadata = mapper.readValue(params.get("client_metadata"), ClientMetadata.class);
            }
            return builder;
    ...
    public AuthorizationRequestBuilder withCodeChallengeMethod(String method) {
        if (method != null && !method.equals("S256"))
    ...
    public AuthorizationRequest build() {
        ...
        if (clientId == null || clientId.isBlank())
            throw new IllegalStateException("No client_id");
        ...
        if (codeChallenge == null && codeChallengeMethod != null) {
            if (codeVerifier == null || codeVerifier.isBlank())
                throw new IllegalStateException("No code verifier");
            try {
