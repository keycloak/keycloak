    ...
    public Response process(Context context) {
        ...
        try {
            ...
            if (jwtAuthorizationGrantProvider.isLimitAccessTokenExpiration()) {
                if (responseBuilder.getAccessToken().getExp() > authorizationGrantContext.getJWT().getExp()) {
                    throw new RuntimeException("Generated access token cannot expire after JWT assertion");
                }
            }
