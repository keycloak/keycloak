...
public class OIDCAttributeMapperHelper {
    private static final KeycloakLogger logger = Logger.getMessageLogger(KeycloakLogger.class, OIDCAttributeMapperHelper.class.getName());
        ...
        if (attributeValue instanceof List) {
            ...
            if (isMultivalued(mappingModel)) {
                ...
                if (valueAsList.size() > 1) {
                    logger.CLIENT.multipleValuesForMapper(attributeValue.toString(), mappingModel.getName());
                }
