...
public class SamlService extends AuthorizationEndpointBase {
    ...
    public abstract class BindingProtocol {
        ...
        protected Response handleSamlResponse(String samlResponse, String relayState) {
            ...
            Response response = authManager.browserLogout(session, realm, userSession, uriInfo, clientConnection, headers, true);
            event.success();
            return response;
        }
        ...
        protected Response logoutRequest(LogoutRequestType logoutRequest, ClientModel client, String relayState) {
            ...
            if (authResult != null) {
                ...
                return authManager.browserLogout(session, realm, userSession, uriInfo, clientConnection, headers, true);
