...
public class SamlProtocol implements LoginProtocol {
    ...
    public static final String SAML_FORCEAUTHN_REQUIREMENT = "forceAuthn=true";
    ...
    public boolean requireReauthentication(UserSessionModel userSession, AuthenticationSessionModel authSession) {
        ...
        if (requireReauthentication == null || requireReauthentication.isEmpty())
            return false;

        return requireReauthentication.equals(SamlProtocol.SAML_FORCEAUTHN_REQUIREMENT);
