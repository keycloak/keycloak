...
public class NotifyUserActionProvider implements WorkflowActionProvider {
    ...
    private ComponentModel getNextNonNotificationAction() {
        ...
        List<ComponentModel> actions = realm.getComponentsStream(policyModel.getId(), WorkflowActionProvider.class.getName())
            .sorted((a, b) -> {
