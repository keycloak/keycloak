...
public class DockerComposeYamlInstallationProviderTest {
    ...
    public void shouldIncludeDockerComposeYamlInZip(ZipInputStream zipInput) throws Exception {
        ...
        List<String> expectedDockerComposeAsStringLines = FileUtils.readLines(new File("src/test/resources/docker-compose-expected.yaml"), Charset.defaultCharset().displayName());
