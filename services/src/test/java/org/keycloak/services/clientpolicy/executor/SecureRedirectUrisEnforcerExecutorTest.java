...
public class SecureRedirectUrisEnforcerExecutorTest {
    ...
    public void failWildcardSubdomainNormalUri() {
        ...
        checkFail("https://*.*.example.org/callback", false, SecureRedirectUrisEnforcerExecutor.ERR_WILDCARD_SUBDOMAIN);
        checkFail("https://*_bar.example.org/callback", false, SecureRedirectUrisEnforcerExecutor.ERR_WILDCARD_SUBDOMAIN);
        checkFail("https://*.example.org:*/callback", false, SecureRedirectUrisEnforcerExecutor.ERR_WILDCARD_SUBDOMAIN);
        ...
        enable(OAUTH_2_1_COMPLIANT);
        checkFail("https://*.example.org/callback", false, SecureRedirectUrisEnforcerExecutor.ERR_NORMALURI);
    }
