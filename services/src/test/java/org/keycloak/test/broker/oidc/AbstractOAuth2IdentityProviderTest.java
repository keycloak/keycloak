...
public class AbstractOAuth2IdentityProviderTest {
	...
	private OAuth2IdentityProviderConfig getConfig(final String autorizationUrl, final String defaultScope, final String clientId, final Boolean isLoginHint, boolean forwardUiLocales) {
		IdentityProviderModel model = new IdentityProviderModel();
		OAuth2IdentityProviderConfig config = new OAuth2IdentityProviderConfig(model);
		...
		config.setForwardUiLocales(forwardUiLocales);
		return config;
	}
