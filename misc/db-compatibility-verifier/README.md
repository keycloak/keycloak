...
*   `db-compatibility-verifier:create-snapshot`
*   `db-compatibility-verifier:verify-compatibility`
*   `db-compatibility-verifier:supported`
*   `db-compatibility-verifier:unsupported`

## Usage

### `create-snapshot` - Creates a snapshot of the current database ChangeSets.
...
```bash
mvn org.keycloak:db-compatibility-verifier-maven-plugin:999.0.0-SNAPSHOT:create-snapshot  \
...
### `verify-compatibility` - Verifies that all detected ChangeSets recorded in either the supported or unsupported JSON files.

```bash
mvn org.keycloak:db-compatibility-verifier-maven-plugin:999.0.0-SNAPSHOT:verify-compatibility \
