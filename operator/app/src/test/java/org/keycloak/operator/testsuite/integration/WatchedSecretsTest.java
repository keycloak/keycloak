...
public class WatchedSecretsTest extends BaseOperatorTest {
    ...
    private void hardcodeDBCredsInCR(Keycloak kc) {
        kc.getSpec().getServerConfiguration().setDbUsername(new ValueOrSecret("postgres"));
        kc.getSpec().getServerConfiguration().setDbPassword(new ValueOrSecret("testpassword"));
    }
