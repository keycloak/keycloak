...
public class KeycloakOIDCClientSpec {
    ...
    @Required
    private KeycloakOIDCClientRepresentation client;
    ...
    public KeycloakOIDCClientRepresentation getClient() {
        return client;
    }

    public void setClient(KeycloakOIDCClientRepresentation client) {
        this.client = client;
    }
