...
public interface Permissions {
    ...
    /**
     * Returns {@code true} if the current user has permissions to query realm resources with the given {@code resourceType}.
     *
     * @param resourceType the realm resource type
     * @return {@code true} if the current user has permissions to query realm resources with the given {@code resourceType}, {@code false} otherwise
     */
    boolean canQuery(String resourceType);
}
