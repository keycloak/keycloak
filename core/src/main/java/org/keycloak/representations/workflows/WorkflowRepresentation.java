...
public class WorkflowRepresentation {
    ...
    public void addAction(WorkflowActionRepresentation action) {
        if (actions == null) {
    ...
    public static class Builder {
        ...
        private final Map<String, List<WorkflowActionRepresentation>> actions = new HashMap<>();
        ...
        public List<WorkflowRepresentation> build() {
            ...
            for (Builder builder : builders) {
                for (Entry<String, List<WorkflowActionRepresentation>> entry : builder.actions.entrySet()) {
                    WorkflowRepresentation workflow = new WorkflowRepresentation(entry.getKey(), builder.config);

                    workflow.setActions(entry.getValue());
