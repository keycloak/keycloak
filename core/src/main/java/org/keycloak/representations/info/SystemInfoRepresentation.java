...
public class SystemInfoRepresentation {
    ...
    public static SystemInfoRepresentation create(long serverStartupTime, String serverVersion) {
        ...
        rep.javaVersion = "NA";//System.getProperty("java.version");
        rep.javaVendor = "NA";//System.getProperty("java.vendor");
        rep.javaVm = "NA";//System.getProperty("java.vm.name");
        rep.javaVmVersion = "NA";//System.getProperty("java.vm.version");
        rep.javaRuntime = "NA";//System.getProperty("java.runtime.name");
        rep.javaHome = "NA";//System.getProperty("java.home");
        rep.osName = "NA";//System.getProperty("os.name");
        rep.osArchitecture = "NA";//System.getProperty("os.arch");
        rep.osVersion = "NA";//System.getProperty("os.version");
        rep.fileEncoding = "NA";//System.getProperty("file.encoding");
        rep.userName = "NA";//System.getProperty("user.name");
        rep.userDir = "NA";//System.getProperty("user.dir");
