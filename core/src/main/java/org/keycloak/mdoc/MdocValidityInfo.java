...
public class MdocValidityInfo {
    ...
    Map<String, Object> toCborMap() {
        // ISO mdoc validity timestamps are CBOR tag 0 date/time strings.
        Map<String, Object> validityInfo = new LinkedHashMap<>();
        validityInfo.put("signed", CborUtil.tdate(signed));
        validityInfo.put("validFrom", CborUtil.tdate(validFrom));
        validityInfo.put("validUntil", CborUtil.tdate(validUntil));
        return validityInfo;
    }
}
