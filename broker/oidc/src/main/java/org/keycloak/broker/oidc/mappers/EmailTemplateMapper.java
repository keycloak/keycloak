 ...
 * @version $Revision: 1 $
 */
public class EmailTemplateMapper extends AbstractClaimMapper {
    ...
    static {
        ...
        property.setHelpText("Template to use to format the email to import.  Substitutions are enclosed in ${}.  For example: '${ALIAS}.${CLAIM.sub}'.  ALIAS is the provider alias.  CLAIM.<NAME> references an ID or Access token claim.");
        property.setType(ProviderConfigProperty.STRING_TYPE);
        property.setDefaultValue("${ALIAS}.${CLAIM.email}");
        configProperties.add(property);
    }

    public static final String PROVIDER_ID = "oidc-email-idp-mapper";
    ...
    public String getDisplayType() {
        return "Email Template Importer";
    }
    ...
    public String getHelpText() {
        return "Format the email to import.";
    }
}
